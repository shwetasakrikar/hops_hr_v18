...
namespace GeneratorBase.MVC.Views.T_Unit
{
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/T_Unit/ShowHideColumns.cshtml")]
...
WriteLiteral(">\r\n    $(document).ready(function ()\r\n    {\r\n         var usrName = \"");
            ...
            #line 4 "..\..\Views\T_Unit\ShowHideColumns.cshtml"
                   Write(User.JavaScriptEncodedName);

            
            #line default
            #line hidden
WriteLiteral("\";\r\n        var myCookie = usrName + \"T_Unit\" + \"");

            
            #line 5 "..\..\Views\T_Unit\ShowHideColumns.cshtml"
...
WriteLiteral("\";\r\n        var host = \"#T_Unit\";\r\n        if (\"");
            ...
            #line 7 "..\..\Views\T_Unit\ShowHideColumns.cshtml"
        Write(ViewData["AssociatedType"]);
...
WriteLiteral("\".length > 0)\r\n            host = \"#\" + \"");
            ...
            #line 8 "..\..\Views\T_Unit\ShowHideColumns.cshtml"
                     Write(ViewData["AssociatedType"]);
...
WriteLiteral(" id=\"ColumnShowHideT_Unit\"");
...
WriteLiteral(" id=\"lblWarningT_Unit\"");
...
WriteLiteral(" onclick=\"ColumnClick(event,\'T_Unit\')\"");
...
WriteAttribute("onclick", Tuple.Create(" onclick=\"", 2435), Tuple.Create("\"", 2543)
, Tuple.Create(Tuple.Create("", 2445), Tuple.Create("showhideSaveCookies(event,", 2445), true)
, Tuple.Create(Tuple.Create(" ", 2471), Tuple.Create("\'T_Unit\',", 2472), true)
, Tuple.Create(Tuple.Create(" ", 2481), Tuple.Create("\'", 2482), true)
            
            #line 43 "..\..\Views\T_Unit\ShowHideColumns.cshtml"
