...
namespace GeneratorBase.MVC.Views.T_CostCenter
{
    ...
    #line 2 "..\..\Views\T_CostCenter\BulkOperation.cshtml"
    using PagedList.Mvc;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/T_CostCenter/BulkOperation.cshtml")]
    public partial class BulkOperation : GeneratorBase.MVC.CustomWebViewPage<PagedList.IPagedList<GeneratorBase.MVC.Models.T_CostCenter>>
    {
        
        #line 97 "..\..\Views\T_CostCenter\BulkOperation.cshtml"
...
WriteLiteral("                                    ");
            ...
            #line 255 "..\..\Views\T_CostCenter\BulkOperation.cshtml"
                               Write(Html.DropDownList("PageSize", new SelectList(new Dictionary<string, int> { { "10", 10 }, { "20", 20 }, { "50", 50 }, { "100", 100 } }, "Key", "Value"), new { @id = "pagesizelistT_CostCenter", 
