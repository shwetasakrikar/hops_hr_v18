...
namespace GeneratorBase.MVC.Views.Account
{
    ...
    public partial class Index : GeneratorBase.MVC.CustomWebViewPage<IEnumerable<GeneratorBase.MVC.Models.EditUserViewModel>>
    {
        public Index()
        {
        }
...
WriteLiteral("></i>  <span>User List</span>\r\n        </h1>\r\n    </div>\r\n</div>\r\n<div");

WriteLiteral(" id=\"dvAccount\"");

WriteLiteral("></div>\r\n");

            
            #line 14 "..\..\Views\Account\Index.cshtml"
Write(Html.Partial("~/Views/Account/IndexPartial.cshtml", Model));
