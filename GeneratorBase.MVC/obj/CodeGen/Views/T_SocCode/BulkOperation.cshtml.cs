...
namespace GeneratorBase.MVC.Views.T_SocCode
{
    ...
    #line 2 "..\..\Views\T_SocCode\BulkOperation.cshtml"
    using PagedList.Mvc;
    ...
    [System.Web.WebPages.PageVirtualPathAttribute("~/Views/T_SocCode/BulkOperation.cshtml")]
    public partial class BulkOperation : GeneratorBase.MVC.CustomWebViewPage<PagedList.IPagedList<GeneratorBase.MVC.Models.T_SocCode>>
    {
        
        #line 97 "..\..\Views\T_SocCode\BulkOperation.cshtml"
        ...
        public override void Execute()
        {
            ...
            #line 3 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("\r\n");
            ...
            #line 10 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("\r\n");
            ...
            #line 11 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
<script>
    ...
    function UpdateRecords() {
        ...
        var url1 = '");
            ...
            #line 36 "..\..\Views\T_SocCode\BulkOperation.cshtml"
               Write(Url.Action("BulkAssociate"));

            
            #line default
            #line hidden
WriteLiteral("\';\r\n\t\t var entity = \'T_SocCode\';\r\n        var host = \'");

            
            #line 38 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
"dvalues, AssociatedType: \'");
            ...
            #line 41 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                     Write(ViewData["AssociatedType"]);
...
");
            ...
            #line 55 "..\..\Views\T_SocCode\BulkOperation.cshtml"
 if (ViewData["BulkAssociate"] != null)
{
            ...
            #line 57 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" class=\"T_SocCode\"");

WriteLiteral(">\r\n");

            
            #line 60 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
");
            ...
            #line 77 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(@">
            $(document).ready(function () {
                ...
                $(""#dvPopupBulkOperation input[name=SearchStringT_SocCode]"").keypress(function (e) {
...
");
            ...
            #line 96 "..\..\Views\T_SocCode\BulkOperation.cshtml"
            ...
            #line 142 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("                                ");
            ...
            #line 149 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                           Write(Html.TextBox("SearchStringT_SocCode", ViewBag.CurrentFilter as string, null, new { @class = "form-control fixsearchbox", @placeholder = "Search" }));
...
, Tuple.Create(Tuple.Create(" ", 6724), Tuple.Create("\'T_SocCode\',", 6725), true)
, Tuple.Create(Tuple.Create(" ", 6737), Tuple.Create("\'", 6738), true)
            
            #line 151 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                      , Tuple.Create(Tuple.Create("", 6739), Tuple.Create<System.Object, System.Int32>(Html.Raw(Url.Action("Index", "T_SocCode", new { BulkAssociate = ViewData["BulkAssociate"], caller = ViewData["caller"],IsFilter = ViewData["IsFilter"], IsDeepSearch = false, searchString = "_SearchString", HostingEntity = Convert.ToString(ViewData["HostingEntity"]), BulkOperation = ViewData["BulkOperation"], HostingEntityID = Convert.ToString(ViewData["HostingEntityID"]), AssociatedType = Convert.ToString(ViewData["AssociatedType"]), SearchTimeStamp = DateTime.Now }))
...
, Tuple.Create(Tuple.Create("", 7511), Tuple.Create("CancelSearchBulk(\'T_SocCode\',\'", 7511), true)
            
            #line 152 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                                                                    , Tuple.Create(Tuple.Create("", 7541), Tuple.Create<System.Object, System.Int32>(Html.Raw(Url.Action("Index", "T_SocCode", new {caller = ViewData["caller"], BulkOperation = ViewData["BulkOperation"], IsFilter=ViewData["IsFilter"], HostingEntity = Convert.ToString(ViewData["HostingEntity"]), HostingEntityID = Convert.ToString(ViewData["HostingEntityID"]), AssociatedType = Convert.ToString(ViewData["AssociatedType"]), ClearSearchTimeStamp = DateTime.Now }))
...
, Tuple.Create(Tuple.Create("", 8284), Tuple.Create("CancelSearchBulk(\'T_SocCode\',\'", 8284), true)
            
            #line 155 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                                                                          , Tuple.Create(Tuple.Create("", 8314), Tuple.Create<System.Object, System.Int32>(Html.Raw(Url.Action("Index", "T_SocCode", new { BulkAssociate = ViewData["BulkAssociate"], caller = ViewData["caller"],IsFilter = ViewData["IsFilter"],HostingEntity = Convert.ToString(ViewData["HostingEntity"]), BulkOperation = ViewData["BulkOperation"], HostingEntityID = Convert.ToString(ViewData["HostingEntityID"]), AssociatedType = Convert.ToString(ViewData["AssociatedType"]), ClearSearchTimeStamp = DateTime.Now }))
...
"              </th>\r\n");
            ...
            #line 170 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("                                                ");
            ...
            #line 173 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                           Write(Html.ActionLink("Display Value", ActionNameUrl, "T_SocCode", getSortHtmlAttributes("DisplayValue", false, null, false), new { @onclick = "SortLinkClick(event,'T_SocCode');" }));
...
WriteLiteral("\r\n");
            ...
            #line 174 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("></i>");
            ...
            #line 175 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                                                }
...
WriteLiteral("                                                ");
            ...
            #line 176 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("></i>");
            ...
            #line 177 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                                               }
...
WriteLiteral("                                            </th>\r\n");
            ...
            #line 179 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                        }
...
WriteLiteral("                                    </tr>\r\n");
            ...
            #line 181 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("                                        <tr>\r\n");
            ...
            #line 184 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
, Tuple.Create(Tuple.Create("", 11113), Tuple.Create("Update(this,\'", 11113), true)
            ...
            #line 189 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n                                                    </td>\r\n");
            ...
            #line 191 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                }
                                                else
                                                {
...
, Tuple.Create(Tuple.Create("", 11525), Tuple.Create("Set(this,\'", 11525), true)
            ...
            #line 195 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n                                                    </td>\r\n");
            ...
            #line 197 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                }
                                            }
                                            else
                                            {
...
, Tuple.Create(Tuple.Create("", 11934), Tuple.Create("SetSingle(this,\'", 11934), true)
            ...
            #line 202 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n\t\t\t\t\t\t\t\t\t\t\t\t</td> \r\n");
            ...
            #line 204 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                            }
...
WriteLiteral("                                            ");
            ...
            #line 205 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                             if (User.CanView("T_SocCode"))
                                            {
...
WriteLiteral("                                                    ");
            ...
            #line 208 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("\r\n                                                </td>\r\n");
            ...
            #line 210 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                            }
...
WriteLiteral("                                        </tr>\r\n");
            ...
            #line 212 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                    }
...
WriteLiteral(">\r\n");
            ...
            #line 216 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(">\r\n");
            ...
            #line 219 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("> Select </span> : <span>\r\n");
            ...
            #line 223 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
, Tuple.Create(Tuple.Create("", 13373), Tuple.Create("Update(this,\'", 13373), true)
            ...
            #line 227 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n");
            ...
            #line 228 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                }
                                                else
                                                {
...
, Tuple.Create(Tuple.Create("", 13668), Tuple.Create("Set(this,\'", 13668), true)
            ...
            #line 231 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n");
            ...
            #line 232 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                                }
                                            }
                                            else
                                            {
...
, Tuple.Create(Tuple.Create("", 13999), Tuple.Create("SetSingle(this,\'", 13999), true)
            ...
            #line 236 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n");
            ...
            #line 237 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                            }
...
WriteLiteral("                                                ");
            ...
            #line 242 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                           Write(Html.DisplayFor(modelItem => item.DisplayValue));
...
"              </p>\r\n");
            ...
            #line 245 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                                    }
...
WriteLiteral("                                </li>\r\n");
            ...
            #line 247 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                            }
...
WriteLiteral("                        </ul>\r\n");
            ...
            #line 249 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("                                ");
            ...
            #line 252 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral("                                    ");
            ...
            #line 255 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                               Write(Html.DropDownList("PageSize", new SelectList(new Dictionary<string, int> { { "10", 10 }, { "20", 20 }, { "50", 50 }, { "100", 100 } }, "Key", "Value"), new { @id = "pagesizelistT_SocCode", 
									@onchange = "pagesizelistChange(event,'T_SocCode')", 
...
WriteLiteral("> Total Count: ");
            ...
            #line 260 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
"v>\r\n");
            ...
            #line 263 "..\..\Views\T_SocCode\BulkOperation.cshtml"
                        }
...
"/div>\r\n");
            ...
            #line 268 "..\..\Views\T_SocCode\BulkOperation.cshtml"
		if (ViewData["BulkAssociate"] != null)
        {
...
, Tuple.Create(Tuple.Create(" ", 16008), Tuple.Create("with", 16009), true)
            ...
            #line 270 "..\..\Views\T_SocCode\BulkOperation.cshtml"
...
WriteLiteral(" />\r\n");
            ...
            #line 271 "..\..\Views\T_SocCode\BulkOperation.cshtml"
        }
    }
