...
{	
    ...
    {
		public bool CheckBeforeDelete(T_SocCode t_soccode)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_SocCode t_soccode, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_SocCode t_soccode)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_SocCode t_soccode, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_SocCode t_soccode)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_SocCode t_soccode)
{
}
private void CustomLoadViewDataListBeforeEdit(T_SocCode t_soccode)
{
}
private void CustomLoadViewDataListAfterEdit(T_SocCode t_soccode)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_SocCode t_soccode, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_SocCode t_soccode, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_SocCode t_soccode, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_SocCode t_soccode, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_SocCode> CustomSorting(IQueryable<T_SocCode> list)
{
    IQueryable<T_SocCode> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_SocCode t_soccode,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_SocCode");
    return null;
}
	}
}
