...
{	
    ...
    {
		public bool CheckBeforeDelete(T_CostCenter t_costcenter)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_CostCenter t_costcenter, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
...
private void CustomLoadViewDataListBeforeEdit(T_CostCenter t_costcenter)
{
}
...
private bool CustomSaveOnCreate(T_CostCenter t_costcenter, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_CostCenter t_costcenter, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_CostCenter t_costcenter, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_CostCenter t_costcenter, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_CostCenter> CustomSorting(IQueryable<T_CostCenter> list)
{
    IQueryable<T_CostCenter> orderedList = list;
