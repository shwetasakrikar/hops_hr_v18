...
{	
    ...
    {
		public bool CheckBeforeDelete(T_CPSResults t_cpsresults)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_CPSResults t_cpsresults, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_CPSResults t_cpsresults)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_CPSResults t_cpsresults, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_CPSResults t_cpsresults)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_CPSResults t_cpsresults)
{
}
private void CustomLoadViewDataListBeforeEdit(T_CPSResults t_cpsresults)
{
}
private void CustomLoadViewDataListAfterEdit(T_CPSResults t_cpsresults)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_CPSResults t_cpsresults, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_CPSResults t_cpsresults, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_CPSResults t_cpsresults, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_CPSResults t_cpsresults, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_CPSResults> CustomSorting(IQueryable<T_CPSResults> list)
{
    IQueryable<T_CPSResults> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_CPSResults t_cpsresults,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_CPSResults");
    return null;
}
	}
}
