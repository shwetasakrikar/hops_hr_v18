...
{	
    ...
    {
		public bool CheckBeforeDelete(T_TestType t_testtype)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_TestType t_testtype, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_TestType t_testtype)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_TestType t_testtype, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_TestType t_testtype)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_TestType t_testtype)
{
}
private void CustomLoadViewDataListBeforeEdit(T_TestType t_testtype)
{
}
private void CustomLoadViewDataListAfterEdit(T_TestType t_testtype)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_TestType t_testtype, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_TestType t_testtype, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_TestType t_testtype, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_TestType t_testtype, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_TestType> CustomSorting(IQueryable<T_TestType> list)
{
    IQueryable<T_TestType> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_TestType t_testtype,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_TestType");
    return null;
}
	}
}
