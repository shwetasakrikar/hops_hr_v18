...
{	
    ...
    {
		public bool CheckBeforeDelete(T_WCAccident t_wcaccident)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_WCAccident t_wcaccident, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_WCAccident t_wcaccident)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_WCAccident t_wcaccident, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_WCAccident t_wcaccident)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_WCAccident t_wcaccident)
{
}
private void CustomLoadViewDataListBeforeEdit(T_WCAccident t_wcaccident)
{
}
private void CustomLoadViewDataListAfterEdit(T_WCAccident t_wcaccident)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_WCAccident t_wcaccident, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_WCAccident t_wcaccident, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_WCAccident t_wcaccident, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_WCAccident t_wcaccident, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_WCAccident> CustomSorting(IQueryable<T_WCAccident> list)
{
    IQueryable<T_WCAccident> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_WCAccident t_wcaccident,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_WCAccident");
    return null;
}
	}
}
