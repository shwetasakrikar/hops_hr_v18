...
{	
    ...
    {
		public bool CheckBeforeDelete(T_RoleCode t_rolecode)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_RoleCode t_rolecode, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_RoleCode t_rolecode)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_RoleCode t_rolecode, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_RoleCode t_rolecode)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_RoleCode t_rolecode)
{
}
private void CustomLoadViewDataListBeforeEdit(T_RoleCode t_rolecode)
{
}
private void CustomLoadViewDataListAfterEdit(T_RoleCode t_rolecode)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_RoleCode t_rolecode, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_RoleCode t_rolecode, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_RoleCode t_rolecode, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_RoleCode t_rolecode, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_RoleCode> CustomSorting(IQueryable<T_RoleCode> list)
{
    IQueryable<T_RoleCode> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_RoleCode t_rolecode,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_RoleCode");
    return null;
}
	}
}
