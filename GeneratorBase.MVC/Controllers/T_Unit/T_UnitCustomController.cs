...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Unit t_unit)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Unit t_unit, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
...
private bool CustomSaveOnCreate(T_Unit t_unit, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Unit t_unit, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Unit t_unit, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Unit t_unit, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Unit> CustomSorting(IQueryable<T_Unit> list)
{
    IQueryable<T_Unit> orderedList = list;
