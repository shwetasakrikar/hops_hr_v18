...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Program t_program)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Program t_program, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Program t_program)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Program t_program, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Program t_program)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Program t_program)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Program t_program)
{
}
private void CustomLoadViewDataListAfterEdit(T_Program t_program)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Program t_program, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Program t_program, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Program t_program, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Program t_program, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Program> CustomSorting(IQueryable<T_Program> list)
{
    IQueryable<T_Program> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Program t_program,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Program");
    return null;
}
	}
}
