...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Comment t_comment)
        {
            var result = true;
		...
		public void OnDeleting(T_Comment t_comment)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Comment t_comment, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Comment t_comment)
        {
            // Write your logic here
...
private bool CustomSaveOnCreate(T_Comment t_comment, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Comment t_comment, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Comment t_comment, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Comment t_comment, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Comment> CustomSorting(IQueryable<T_Comment> list)
{
    IQueryable<T_Comment> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Comment t_comment,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Comment");
    return null;
}
	}
}
