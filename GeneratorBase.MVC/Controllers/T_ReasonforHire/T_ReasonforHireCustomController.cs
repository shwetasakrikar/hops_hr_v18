...
{	
    ...
    {
		public bool CheckBeforeDelete(T_ReasonforHire t_reasonforhire)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_ReasonforHire t_reasonforhire, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_ReasonforHire t_reasonforhire)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_ReasonforHire t_reasonforhire, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_ReasonforHire t_reasonforhire)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_ReasonforHire t_reasonforhire)
{
}
private void CustomLoadViewDataListBeforeEdit(T_ReasonforHire t_reasonforhire)
{
}
private void CustomLoadViewDataListAfterEdit(T_ReasonforHire t_reasonforhire)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_ReasonforHire t_reasonforhire, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_ReasonforHire t_reasonforhire, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_ReasonforHire t_reasonforhire, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_ReasonforHire t_reasonforhire, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_ReasonforHire> CustomSorting(IQueryable<T_ReasonforHire> list)
{
    IQueryable<T_ReasonforHire> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_ReasonforHire t_reasonforhire,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_ReasonforHire");
    return null;
}
	}
}
