...
{	
    ...
    {
		public bool CheckBeforeDelete(T_ClassCode t_classcode)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_ClassCode t_classcode, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_ClassCode t_classcode)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_ClassCode t_classcode, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_ClassCode t_classcode)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_ClassCode t_classcode)
{
}
private void CustomLoadViewDataListBeforeEdit(T_ClassCode t_classcode)
{
}
private void CustomLoadViewDataListAfterEdit(T_ClassCode t_classcode)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_ClassCode t_classcode, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_ClassCode t_classcode, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_ClassCode t_classcode, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_ClassCode t_classcode, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_ClassCode> CustomSorting(IQueryable<T_ClassCode> list)
{
    IQueryable<T_ClassCode> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_ClassCode t_classcode,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_ClassCode");
    return null;
}
	}
}
