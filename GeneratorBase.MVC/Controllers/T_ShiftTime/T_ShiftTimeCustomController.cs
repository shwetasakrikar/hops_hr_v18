...
{	
    ...
    {
		public bool CheckBeforeDelete(T_ShiftTime t_shifttime)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_ShiftTime t_shifttime, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_ShiftTime t_shifttime)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_ShiftTime t_shifttime, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_ShiftTime t_shifttime)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_ShiftTime t_shifttime)
{
}
private void CustomLoadViewDataListBeforeEdit(T_ShiftTime t_shifttime)
{
}
private void CustomLoadViewDataListAfterEdit(T_ShiftTime t_shifttime)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_ShiftTime t_shifttime, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_ShiftTime t_shifttime, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_ShiftTime t_shifttime, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_ShiftTime t_shifttime, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_ShiftTime> CustomSorting(IQueryable<T_ShiftTime> list)
{
    IQueryable<T_ShiftTime> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_ShiftTime t_shifttime,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_ShiftTime");
    return null;
}
	}
}
