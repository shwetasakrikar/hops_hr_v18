...
{	
    ...
    {
		public bool CheckBeforeDelete(T_WorkingTitle t_workingtitle)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_WorkingTitle t_workingtitle, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_WorkingTitle t_workingtitle)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_WorkingTitle t_workingtitle, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_WorkingTitle t_workingtitle)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_WorkingTitle t_workingtitle)
{
}
private void CustomLoadViewDataListBeforeEdit(T_WorkingTitle t_workingtitle)
{
}
private void CustomLoadViewDataListAfterEdit(T_WorkingTitle t_workingtitle)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_WorkingTitle t_workingtitle, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_WorkingTitle t_workingtitle, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_WorkingTitle t_workingtitle, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_WorkingTitle t_workingtitle, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_WorkingTitle> CustomSorting(IQueryable<T_WorkingTitle> list)
{
    IQueryable<T_WorkingTitle> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_WorkingTitle t_workingtitle,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_WorkingTitle");
    return null;
}
	}
}
