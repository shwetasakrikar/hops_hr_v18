...
{	
    ...
    {
		public bool CheckBeforeDelete(T_EEOCode t_eeocode)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_EEOCode t_eeocode, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_EEOCode t_eeocode)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_EEOCode t_eeocode, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_EEOCode t_eeocode)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_EEOCode t_eeocode)
{
}
private void CustomLoadViewDataListBeforeEdit(T_EEOCode t_eeocode)
{
}
private void CustomLoadViewDataListAfterEdit(T_EEOCode t_eeocode)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_EEOCode t_eeocode, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_EEOCode t_eeocode, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_EEOCode t_eeocode, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_EEOCode t_eeocode, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_EEOCode> CustomSorting(IQueryable<T_EEOCode> list)
{
    IQueryable<T_EEOCode> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_EEOCode t_eeocode,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_EEOCode");
    return null;
}
	}
}
