...
{	
    ...
    {
		public bool CheckBeforeDelete(T_CardEmplGrp t_cardemplgrp)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_CardEmplGrp t_cardemplgrp, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_CardEmplGrp t_cardemplgrp)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_CardEmplGrp t_cardemplgrp, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_CardEmplGrp t_cardemplgrp)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_CardEmplGrp t_cardemplgrp)
{
}
private void CustomLoadViewDataListBeforeEdit(T_CardEmplGrp t_cardemplgrp)
{
}
private void CustomLoadViewDataListAfterEdit(T_CardEmplGrp t_cardemplgrp)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_CardEmplGrp t_cardemplgrp, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_CardEmplGrp t_cardemplgrp, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_CardEmplGrp t_cardemplgrp, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_CardEmplGrp t_cardemplgrp, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_CardEmplGrp> CustomSorting(IQueryable<T_CardEmplGrp> list)
{
    IQueryable<T_CardEmplGrp> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_CardEmplGrp t_cardemplgrp,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_CardEmplGrp");
    return null;
}
	}
}
