...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Country t_country)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Country t_country, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Country t_country)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Country t_country, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Country t_country)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Country t_country)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Country t_country)
{
}
private void CustomLoadViewDataListAfterEdit(T_Country t_country)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Country t_country, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Country t_country, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Country t_country, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Country t_country, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Country> CustomSorting(IQueryable<T_Country> list)
{
    IQueryable<T_Country> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Country t_country,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Country");
    return null;
}
	}
}
