...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Nationality t_nationality)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Nationality t_nationality, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Nationality t_nationality)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Nationality t_nationality, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Nationality t_nationality)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Nationality t_nationality)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Nationality t_nationality)
{
}
private void CustomLoadViewDataListAfterEdit(T_Nationality t_nationality)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Nationality t_nationality, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Nationality t_nationality, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Nationality t_nationality, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Nationality t_nationality, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Nationality> CustomSorting(IQueryable<T_Nationality> list)
{
    IQueryable<T_Nationality> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Nationality t_nationality,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Nationality");
    return null;
}
	}
}
