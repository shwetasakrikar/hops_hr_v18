...
private bool CustomSaveOnCreate(T_Education t_education, out bool customcreate_hasissues, string command="")
{
            var result = false;
...
private IQueryable<T_Education> CustomSorting(IQueryable<T_Education> list)
{
    IQueryable<T_Education> orderedList = list;
