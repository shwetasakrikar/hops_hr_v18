...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Langauge t_langauge)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Langauge t_langauge, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Langauge t_langauge)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Langauge t_langauge, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Langauge t_langauge)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Langauge t_langauge)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Langauge t_langauge)
{
}
private void CustomLoadViewDataListAfterEdit(T_Langauge t_langauge)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Langauge t_langauge, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Langauge t_langauge, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Langauge t_langauge, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Langauge t_langauge, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Langauge> CustomSorting(IQueryable<T_Langauge> list)
{
    IQueryable<T_Langauge> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Langauge t_langauge,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Langauge");
    return null;
}
	}
}
