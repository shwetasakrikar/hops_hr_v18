...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Gender t_gender)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Gender t_gender, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Gender t_gender)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Gender t_gender, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Gender t_gender)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Gender t_gender)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Gender t_gender)
{
}
private void CustomLoadViewDataListAfterEdit(T_Gender t_gender)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Gender t_gender, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Gender t_gender, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Gender t_gender, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Gender t_gender, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Gender> CustomSorting(IQueryable<T_Gender> list)
{
    IQueryable<T_Gender> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Gender t_gender,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Gender");
    return null;
}
	}
}
