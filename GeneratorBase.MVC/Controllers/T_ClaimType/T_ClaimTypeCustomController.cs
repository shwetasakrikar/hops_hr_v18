...
{	
    ...
    {
		public bool CheckBeforeDelete(T_ClaimType t_claimtype)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_ClaimType t_claimtype, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_ClaimType t_claimtype)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_ClaimType t_claimtype, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_ClaimType t_claimtype)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_ClaimType t_claimtype)
{
}
private void CustomLoadViewDataListBeforeEdit(T_ClaimType t_claimtype)
{
}
private void CustomLoadViewDataListAfterEdit(T_ClaimType t_claimtype)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_ClaimType t_claimtype, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_ClaimType t_claimtype, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_ClaimType t_claimtype, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_ClaimType t_claimtype, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_ClaimType> CustomSorting(IQueryable<T_ClaimType> list)
{
    IQueryable<T_ClaimType> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_ClaimType t_claimtype,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_ClaimType");
    return null;
}
	}
}
