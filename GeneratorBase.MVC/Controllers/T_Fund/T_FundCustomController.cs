...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Fund t_fund)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Fund t_fund, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Fund t_fund)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Fund t_fund, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Fund t_fund)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Fund t_fund)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Fund t_fund)
{
}
private void CustomLoadViewDataListAfterEdit(T_Fund t_fund)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Fund t_fund, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Fund t_fund, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Fund t_fund, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Fund t_fund, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Fund> CustomSorting(IQueryable<T_Fund> list)
{
    IQueryable<T_Fund> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Fund t_fund,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Fund");
    return null;
}
	}
}
