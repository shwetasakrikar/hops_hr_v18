...
{	
    ...
    {
		private void LoadViewDataForCount(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage, string AssocType)
        {
        }
		private void LoadViewDataAfterOnEdit(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage)
        {		
			 ViewBag.T_EmployeeID = new SelectList(db.T_Employees, "ID", "DisplayValue", t_conversationalemployeeforeignlanguage.T_EmployeeID);
			 ViewBag.T_LangaugeID = new SelectList(db.T_Langauges, "ID", "DisplayValue", t_conversationalemployeeforeignlanguage.T_LangaugeID);
			CustomLoadViewDataListAfterEdit(t_conversationalemployeeforeignlanguage);
        }
        private void LoadViewDataBeforeOnEdit(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage)
        {		
               var _objT_Employee = new List<T_Employee>();
               _objT_Employee.Add(t_conversationalemployeeforeignlanguage.t_employee);
			   			   ViewBag.T_EmployeeID = new SelectList(_objT_Employee, "ID", "DisplayValue", t_conversationalemployeeforeignlanguage.T_EmployeeID);
			               var _objT_Langauge = new List<T_Langauge>();
               _objT_Langauge.Add(t_conversationalemployeeforeignlanguage.t_langauge);
			   			   ViewBag.T_LangaugeID = new SelectList(_objT_Langauge, "ID", "DisplayValue", t_conversationalemployeeforeignlanguage.T_LangaugeID);
					CustomLoadViewDataListBeforeEdit(t_conversationalemployeeforeignlanguage);
        }
        private void LoadViewDataAfterOnCreate(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage)
        {			
			 ViewBag.T_EmployeeID = new SelectList(db.T_Employees, "ID", "DisplayValue", t_conversationalemployeeforeignlanguage.T_EmployeeID);
			 ViewBag.T_LangaugeID = new SelectList(db.T_Langauges, "ID", "DisplayValue", t_conversationalemployeeforeignlanguage.T_LangaugeID);
		CustomLoadViewDataListAfterOnCreate(t_conversationalemployeeforeignlanguage);
        }
        private void LoadViewDataBeforeOnCreate(string HostingEntityName, string HostingEntityID, string AssociatedType)
        {			
			if(HostingEntityName == "T_Employee" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_ConversationalEmployeeForeignLanguage_T_Employee")
			{
			    var hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_EmployeeID = new SelectList(db.T_Employees.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_Employees.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{
						//ManytoOne association
						var T_EmployeeAtFacilitylist = db.T_Facilitys.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeeatfacility = new SelectList(T_EmployeeAtFacilitylist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeStatuslist = db.T_EmployeeStatusCodes.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeestatus = new SelectList(T_EmployeeStatuslist, "ID", "DisplayValue");
						//ManytoOne association
						var T_CurrentEmployeeEmploymentProfilelist = db.T_ServiceRecords.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_currentemployeeemploymentprofile = new SelectList(T_CurrentEmployeeEmploymentProfilelist, "ID", "DisplayValue");
						//ManytoOne association
						var T_CurrentEmployeeJobAssignmentlist = db.T_JobAssignments.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_currentemployeejobassignment = new SelectList(T_CurrentEmployeeJobAssignmentlist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeGenderlist = db.T_Genders.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeegender = new SelectList(T_EmployeeGenderlist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeRacelist = db.T_Races.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeerace = new SelectList(T_EmployeeRacelist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeNationalityAssociationlist = db.T_Nationalitys.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeenationalityassociation = new SelectList(T_EmployeeNationalityAssociationlist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeVeteranStatuslist = db.T_VeteranStatuss.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeeveteranstatus = new SelectList(T_EmployeeVeteranStatuslist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeCardEmplGrpAssociationlist = db.T_CardEmplGrps.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeecardemplgrpassociation = new SelectList(T_EmployeeCardEmplGrpAssociationlist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeCardLvPlanAssociationlist = db.T_CardLvPlans.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeecardlvplanassociation = new SelectList(T_EmployeeCardLvPlanAssociationlist, "ID", "DisplayValue");
						//ManytoOne association
						var T_EmployeeAddresslist = db.T_Addresss.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
						ViewBag.t_employeeaddress = new SelectList(T_EmployeeAddresslist, "ID", "DisplayValue");
								//Manytomany associations
								var T_ConversationalEmployeeForeignLanguagelist = db.T_Langauges.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
								ViewBag.t_conversationalemployeeforeignlanguage = new SelectList(T_ConversationalEmployeeForeignLanguagelist, "ID", "DisplayValue");
								//Manytomany associations
								var T_LanguageCertifiedInlist = db.T_Langauges.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
								ViewBag.t_languagecertifiedin = new SelectList(T_LanguageCertifiedInlist, "ID", "DisplayValue");
				var hostid = Convert.ToInt64(HostingEntityID);
                var Selectedlist = db.T_ConversationalEmployeeForeignLanguages.Where(p => p.T_LangaugeID == hostid).Select(q => q.T_EmployeeID);
		var AvailableList = db.T_Employees.Where(p => !Selectedlist.Contains(p.Id));
		FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
        AvailableList = _fad.FilterDropdown<T_Employee>(User, AvailableList, "T_Employee", "T_ConversationalEmployeeForeignLanguage.T_EmployeeID");
                ViewBag.IsTop50 = "none";
				if (AvailableList.Count() > 50)
                    ViewBag.IsTop50 = "block";
				ViewBag.T_EmployeeIDAvailable  = new SelectList(AvailableList.OrderBy(p => p.DisplayValue).Take(50).ToList(), "ID", "DisplayValue");
				var SelectedListComplete = db.T_Employees.Where(p => Selectedlist.Contains(p.Id));
				var SelectedListFiltered = db.T_Employees.Where(p => Selectedlist.Contains(p.Id));
				SelectedListFiltered = _fad.FilterDropdown<T_Employee>(User, SelectedListFiltered, "T_Employee", "T_ConversationalEmployeeForeignLanguage.T_EmployeeID");
				ViewBag.SelectedListRemoved= string.Join(",", SelectedListComplete.Except(SelectedListFiltered).Select(p=>p.Id).ToList());
                ViewBag.T_EmployeeIDSelected = new MultiSelectList(SelectedListComplete.OrderBy(p => p.DisplayValue).ToList(), "ID", "DisplayValue", Selectedlist);
		    }
			if(HostingEntityName == "T_Langauge" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_ConversationalEmployeeForeignLanguage_T_Langauge")
			{
			    var hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_LangaugeID = new SelectList(db.T_Langauges.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_Langauges.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{
								//Manytomany associations
								var T_ConversationalEmployeeForeignLanguagelist = db.T_Employees.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
								ViewBag.t_conversationalemployeeforeignlanguage = new SelectList(T_ConversationalEmployeeForeignLanguagelist, "ID", "DisplayValue");
								//Manytomany associations
								var T_LanguageCertifiedInlist = db.T_Employees.OrderBy(p => p.DisplayValue).Take(10).Distinct().ToList();
								ViewBag.t_languagecertifiedin = new SelectList(T_LanguageCertifiedInlist, "ID", "DisplayValue");
				var hostid = Convert.ToInt64(HostingEntityID);
                var Selectedlist = db.T_ConversationalEmployeeForeignLanguages.Where(p => p.T_EmployeeID == hostid).Select(q => q.T_LangaugeID);
		var AvailableList = db.T_Langauges.Where(p => !Selectedlist.Contains(p.Id));
		FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
        AvailableList = _fad.FilterDropdown<T_Langauge>(User, AvailableList, "T_Langauge", "T_ConversationalEmployeeForeignLanguage.T_LangaugeID");
                ViewBag.IsTop50 = "none";
				if (AvailableList.Count() > 50)
                    ViewBag.IsTop50 = "block";
				ViewBag.T_LangaugeIDAvailable  = new SelectList(AvailableList.OrderBy(p => p.DisplayValue).Take(50).ToList(), "ID", "DisplayValue");
				var SelectedListComplete = db.T_Langauges.Where(p => Selectedlist.Contains(p.Id));
				var SelectedListFiltered = db.T_Langauges.Where(p => Selectedlist.Contains(p.Id));
				SelectedListFiltered = _fad.FilterDropdown<T_Langauge>(User, SelectedListFiltered, "T_Langauge", "T_ConversationalEmployeeForeignLanguage.T_LangaugeID");
				ViewBag.SelectedListRemoved= string.Join(",", SelectedListComplete.Except(SelectedListFiltered).Select(p=>p.Id).ToList());
                ViewBag.T_LangaugeIDSelected = new MultiSelectList(SelectedListComplete.OrderBy(p => p.DisplayValue).ToList(), "ID", "DisplayValue", Selectedlist);
		    }
			CustomLoadViewDataListBeforeOnCreate(HostingEntityName, HostingEntityID, AssociatedType);
        }
		private IQueryable<T_ConversationalEmployeeForeignLanguage> searchRecords(IQueryable<T_ConversationalEmployeeForeignLanguage> lstT_ConversationalEmployeeForeignLanguage, string searchString, bool? IsDeepSearch)
        {
		   searchString = searchString.Trim();
		if(Convert.ToBoolean(IsDeepSearch))
            lstT_ConversationalEmployeeForeignLanguage = lstT_ConversationalEmployeeForeignLanguage.Where(s => (s.t_employee!= null && (s.t_employee.DisplayValue.ToUpper().Contains(searchString) )) ||(s.t_langauge!= null && (s.t_langauge.DisplayValue.ToUpper().Contains(searchString) )) ||(!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
		else
			 lstT_ConversationalEmployeeForeignLanguage = lstT_ConversationalEmployeeForeignLanguage.Where(s => (s.t_employee!= null && (s.t_employee.DisplayValue.ToUpper().Contains(searchString) )) ||(s.t_langauge!= null && (s.t_langauge.DisplayValue.ToUpper().Contains(searchString) )) ||(!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
            return lstT_ConversationalEmployeeForeignLanguage;
        }
		private IQueryable<T_ConversationalEmployeeForeignLanguage> sortRecords(IQueryable<T_ConversationalEmployeeForeignLanguage> lstT_ConversationalEmployeeForeignLanguage, string sortBy, string isAsc)
        {
            string methodName = "";
		    ...
		    if (sortBy.Contains("."))
                return isAsc.ToLower() == "asc" ? lstT_ConversationalEmployeeForeignLanguage.Sort(sortBy,true) : lstT_ConversationalEmployeeForeignLanguage.Sort(sortBy,false);
            ParameterExpression paramExpression = Expression.Parameter(typeof(T_ConversationalEmployeeForeignLanguage), "t_conversationalemployeeforeignlanguage");
            MemberExpression memExp = Expression.PropertyOrField(paramExpression, sortBy);
            LambdaExpression lambda = Expression.Lambda(memExp, paramExpression);
            return (IQueryable<T_ConversationalEmployeeForeignLanguage>)lstT_ConversationalEmployeeForeignLanguage.Provider.CreateQuery(
                Expression.Call(
                    typeof(Queryable),
                    methodName,
                    new Type[] { lstT_ConversationalEmployeeForeignLanguage.ElementType, lambda.Body.Type },
                    lstT_ConversationalEmployeeForeignLanguage.Expression,
                    lambda));
        }
		public ActionResult FindFSearch(string id, string sourceEntity)
        {
            if (sourceEntity == "FileDocument")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeDocumentsID;
						url += "&t_employee=" + T_Employee;									
            ...
            if (sourceEntity == "T_Licenses")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_LicenseRecordsID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_ServiceRecord")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeEmploymentProfileID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_Comment")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeCommentsID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_DrugAlcoholTest")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeDrugAlcoholTestID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_UnitX")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeAdministratorID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_JobAssignment")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeJobAssignmentID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_LeaveProfile")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeLeaveProfileID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_EmployeeInjury")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeEmployeeInjuryID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_BackgroundCheck")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeCriminalBackgroundCheckID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_Education")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeEducationID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_Accommodation")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeeAccomodationID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            if (sourceEntity == "T_PayDetails")
            {
                ...
                url += "?search=";
						var T_Employee  = _Object.T_EmployeePayDetailsID;
						url += "&t_employee=" + T_Employee;									
                Response.Redirect(url.ToString());
            }
            return null;
        }
        public ActionResult SetFSearch(string searchString, string HostingEntity ,string t_employee,string t_langauge, bool? RenderPartial)
        {
			int Qcount = 0;
			...
			if(Qcount > 0)
			{
			var T_Employeelist = db.T_Employees.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_employee != null)
            {
                var ids = t_employee.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n Employees Conversational In= ";
				   foreach (var str in ids)
					...
					ids1 = ids1.ToList();
					var list = T_Employeelist.Union(db.T_Employees.Where(p=>ids1.Contains(p.Id))).Distinct();
					FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
					list = _fad.FilterDropdown<T_Employee>(User, list, "T_Employee", null);
					ViewBag.t_employee = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				var list = T_Employeelist;
				FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
				list = _fad.FilterDropdown<T_Employee>(User, list, "T_Employee", null);
				ViewBag.t_employee = new SelectList(list, "ID", "DisplayValue");
			}
			var T_Langaugelist = db.T_Langauges.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_langauge != null)
            {
                var ids = t_langauge.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n Conversational Foreign Language= ";
				   foreach (var str in ids)
					...
					ids1 = ids1.ToList();
					var list = T_Langaugelist.Union(db.T_Langauges.Where(p=>ids1.Contains(p.Id))).Distinct();
					FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
					list = _fad.FilterDropdown<T_Langauge>(User, list, "T_Langauge", null);
					ViewBag.t_langauge = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				var list = T_Langaugelist;
				FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
				list = _fad.FilterDropdown<T_Langauge>(User, list, "T_Langauge", null);
				ViewBag.t_langauge = new SelectList(list, "ID", "DisplayValue");
			}
		    ...
		    ViewBag.t_employee = new SelectList(objT_Employee, "ID", "DisplayValue");
			var objT_Langauge = new List<T_Langauge>();
		    ViewBag.t_langauge = new SelectList(objT_Langauge, "ID", "DisplayValue");
			}
				...
				ViewBag.EntityName = "T_ConversationalEmployeeForeignLanguage";
               ...
               = ViewBag.SuggestedPropertyValue = ViewBag.AssociationPropertyList = ViewBag.SuggestedDynamicValueInCondition71 = new SelectList(Dumplist, "key", "value");
				...
				return View(new T_ConversationalEmployeeForeignLanguage());
            }
		public string conditionFSearch(string property, string operators, string value)
        {
            string expression = string.Empty;
            var PrpertyType = GetDataTypeOfProperty("T_ConversationalEmployeeForeignLanguage", property);
            var dataType = PrpertyType[0];
            property = PrpertyType[1];
            if (value.StartsWith("[") && value.EndsWith("]"))
            {
                var ValueType = GetDataTypeOfProperty("T_ConversationalEmployeeForeignLanguage", value, true);
                ...
                case "DateTime":
                    {
					   ...
					   {
							expression = string.Format(" DbFunctions.TruncateTime(" + property + ") " + operators + " (\"{0}\")", (TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, (new T_ConversationalEmployeeForeignLanguage()).m_Timezone)).Date);
						}
						else
						{
		...
		// GET: /T_ConversationalEmployeeForeignLanguage/FSearch/
		public ActionResult FSearch(string currentFilter, string searchString, string FSFilter, string sortBy, string isAsc, int? page, int? itemsPerPage, string search, bool? IsExport ,string t_employee,string t_langauge ,string FilterCondition, string HostingEntity, string AssociatedType,string HostingEntityID, string viewtype, string SortOrder, string HideColumns, string GroupByColumn,bool? IsReports, bool? IsdrivedTab)
        {
            ...
            {
                lstT_ConversationalEmployeeForeignLanguage  = searchRecords(lstT_ConversationalEmployeeForeignLanguage, searchString.ToUpper(),true);
            }
			  if(!string.IsNullOrEmpty(search))
                	search=search.Replace("?IsAddPop=true", "");
			if(!string.IsNullOrEmpty(search)){
				ViewBag.SearchResult += "\r\n General Criterial= "+search;
				lstT_ConversationalEmployeeForeignLanguage = searchRecords(lstT_ConversationalEmployeeForeignLanguage, search,true);
			}
			...
			lstT_ConversationalEmployeeForeignLanguage = lstT_ConversationalEmployeeForeignLanguage.Include(t=>t.t_employee).Include(t=>t.t_langauge);
			if (!string.IsNullOrEmpty(FilterCondition))
            {
                ...
                foreach (var cond in conditions)
                {
                    ...
                    if (iCnt == conditions.Count())
                        LogicalConnector = "";
					ViewBag.SearchResult += " " + GetPropertyDP("T_ConversationalEmployeeForeignLanguage", PropertyName) + " " + Operator + " " + Value + " " + LogicalConnector;
                    whereCondition.Append(conditionFSearch(PropertyName, Operator, Value) + LogicalConnector);
                    iCnt++;
                }
                if (!string.IsNullOrEmpty(whereCondition.ToString()))
                    lstT_ConversationalEmployeeForeignLanguage = lstT_ConversationalEmployeeForeignLanguage.Where(whereCondition.ToString());
            ...
            if (!string.IsNullOrEmpty(DataOrdering))
                lstT_ConversationalEmployeeForeignLanguage = Sorting.Sort<T_ConversationalEmployeeForeignLanguage>(lstT_ConversationalEmployeeForeignLanguage, DataOrdering);
            var _T_ConversationalEmployeeForeignLanguage = lstT_ConversationalEmployeeForeignLanguage;
			//if (lstT_ConversationalEmployeeForeignLanguage.Where(p => p.t_employee != null).Count() <= 50)
		    //ViewBag.t_employee = new SelectList(lstT_ConversationalEmployeeForeignLanguage.Where(p => p.t_employee != null).Select(P => P.t_employee).Distinct(), "ID", "DisplayValue");
            if (t_employee != null)
            {
                var ids = t_employee.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
                ...
                ids1 = ids1.ToList();
                _T_ConversationalEmployeeForeignLanguage = _T_ConversationalEmployeeForeignLanguage.Where(p => ids1.Contains(p.T_EmployeeID));
            }
				//if (lstT_ConversationalEmployeeForeignLanguage.Where(p => p.t_langauge != null).Count() <= 50)
		    //ViewBag.t_langauge = new SelectList(lstT_ConversationalEmployeeForeignLanguage.Where(p => p.t_langauge != null).Select(P => P.t_langauge).Distinct(), "ID", "DisplayValue");
            if (t_langauge != null)
            {
                var ids = t_langauge.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ...
				 foreach (var str in ids)
                {
                    ...
                    if (!string.IsNullOrEmpty(str))
                    {
                        ...
                        {
                            ids1.Add(Convert.ToInt64(str));
                            var obj = db.T_Langauges.Find(Convert.ToInt64(str));
                            ViewBag.SearchResult += obj != null ? obj.DisplayValue + ", " : "";
                        }
                    }
                    //
                ...
                ids1 = ids1.ToList();
                _T_ConversationalEmployeeForeignLanguage = _T_ConversationalEmployeeForeignLanguage.Where(p => ids1.Contains(p.T_LangaugeID));
            }
				if (!string.IsNullOrEmpty(SortOrder))
            {
                ViewBag.SearchResult += " \r\n Sort Order = ";
                ...
                var Entity = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_ConversationalEmployeeForeignLanguage");
			...
			if (!Request.IsAjaxRequest())
			{
				...
				if (!string.IsNullOrEmpty(GroupByColumn))
                    foreach (var item in list)
                    {
                        ...
                        item.m_DisplayValue = EntityComparer.GetGroupByDisplayValue(item, "T_ConversationalEmployeeForeignLanguage", tagsSplit.ToArray());
                    }
		...
		var entity = "T_ConversationalEmployeeForeignLanguage";
           ...
           var entitylist = db.T_ConversationalEmployeeForeignLanguages;
		...
		public string ShowGraph1(string type, int? inlarge)
        {
            string result = "";
           {
                var gd = db.T_ConversationalEmployeeForeignLanguages.GroupBy(p => p.t_employee.DisplayValue).ToList();
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.BorderSkin.SkinStyle = BorderSkinStyle.Emboss;
				if (cntgrt10)
                chart.Titles.Add(CreateTitle("Count by Employees Conversational In (Top 10)"));
				else
				 chart.Titles.Add(CreateTitle("Count by Employees Conversational In"));
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Column, "", "Employees Conversational In", "Conversational Employee Foreign Language"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_ConversationalEmployeeForeignLanguage", new { type = "1", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
           ...
           {
                var gd = db.T_ConversationalEmployeeForeignLanguages.GroupBy(p => p.t_langauge.DisplayValue).ToList();
                var _xval = gd.Select(k => Convert.ToString(k.Key)).ToList();
				if (type == "2" || type == "all")
                {
                    var cntgrt10 = false;
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.BorderSkin.SkinStyle = BorderSkinStyle.Emboss;
				if (cntgrt10)
                chart.Titles.Add(CreateTitle("Count by Conversational Foreign Language (Top 10)"));
				else
				 chart.Titles.Add(CreateTitle("Count by Conversational Foreign Language"));
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Pie, "", "Conversational Foreign Language", "Conversational Employee Foreign Language"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_ConversationalEmployeeForeignLanguage", new { type = "2", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
        ...
        public string GetDisplayValue(string id)
        {
            ...
            var _Obj = db1.T_ConversationalEmployeeForeignLanguages.FirstOrDefault(p => p.Id == idvalue);
		...
		public object GetRecordById(string id)
        {
		            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            if (string.IsNullOrEmpty(id)) return "";
            var _Obj = db1.T_ConversationalEmployeeForeignLanguages.Find(Convert.ToInt64(id));
            return _Obj;
        }
		public string GetRecordById_Reflection(string id)
        {
			...
			if (string.IsNullOrEmpty(id)) return "";
			var _Obj = db1.T_ConversationalEmployeeForeignLanguages.Find(Convert.ToInt64(id));
            return _Obj == null ? "" : EntityComparer.EnumeratePropertyValues<T_ConversationalEmployeeForeignLanguage>(_Obj, "T_ConversationalEmployeeForeignLanguage", new string[] { ""  }); ;
			        }
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetAllValueForFilter(string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
		            IQueryable<T_ConversationalEmployeeForeignLanguage> list = db.T_ConversationalEmployeeForeignLanguages;
		...
		public JsonResult GetAllValue(string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                {
                    IQueryable query = db.T_ConversationalEmployeeForeignLanguages;
					string lambda = "";
                   ...
                   // ParameterExpression p = Expression.Parameter(typeof(T_ConversationalEmployeeForeignLanguage), "p");
                   // MemberExpression member = Expression.PropertyOrField(p, propToWhere);
                   // LambdaExpression lambda = Expression.Lambda<Func<T_ConversationalEmployeeForeignLanguage, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(AssoID), member.Type)), p);
                   // MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
                   // IQueryable q = query.Provider.CreateQuery(methodCall);
                   //list = ((IQueryable<T_ConversationalEmployeeForeignLanguage>)q);
				   list = ((IQueryable<T_ConversationalEmployeeForeignLanguage>)query);
                }
				else if (AssoID == 0)
                {
                   IQueryable query = db.T_ConversationalEmployeeForeignLanguages;
			...
			FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
            list = _fad.FilterDropdown<T_ConversationalEmployeeForeignLanguage>(User,list, "T_ConversationalEmployeeForeignLanguage",caller);
        ...
        {
			int pagesize = 50;
			if (HostingEntityName == "T_Employee")
            {
				var hostid = Convert.ToInt64(HostingEntityID);
                var Selectedlist = db.T_ConversationalEmployeeForeignLanguages.Where(p => p.T_EmployeeID == hostid).Select(q => q.T_LangaugeID);
		FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
        var Finallist = _fad.FilterDropdown<T_Langauge>(User, db.T_Langauges.Where(p => !Selectedlist.Contains(p.Id)), "T_Langauge", "T_ConversationalEmployeeForeignLanguage.T_LangaugeID").ToList();
                if(!string.IsNullOrEmpty(SearchString))
            ...
            if (HostingEntityName == "T_Langauge")
            {
				var hostid = Convert.ToInt64(HostingEntityID);
                var Selectedlist = db.T_ConversationalEmployeeForeignLanguages.Where(p => p.T_LangaugeID == hostid).Select(q => q.T_EmployeeID);
		FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
         var Finallist = _fad.FilterDropdown<T_Employee>(User, db.T_Employees.Where(p => !Selectedlist.Contains(p.Id)), "T_Employee", "T_ConversationalEmployeeForeignLanguage.T_EmployeeID").ToList();
                if(!string.IsNullOrEmpty(SearchString))
                    Finallist = Finallist.Where(p=>p.DisplayValue.ToUpper().Contains(SearchString.ToUpper())).OrderBy(p => p.DisplayValue).ToList();
                else
                    Finallist = Finallist.OrderBy(p => p.DisplayValue).ToList();
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetAllValues1(string SearchString, string HostingEntityName, string HostingEntityID, string AssociatedType, string size , string t_employeeatfacility,string t_employeestatus,string t_currentemployeeemploymentprofile,string t_currentemployeejobassignment,string t_employeegender,string t_employeerace,string t_employeenationalityassociation,string t_employeeveteranstatus,string t_employeecardemplgrpassociation,string t_employeecardlvplanassociation,string t_employeeaddress,string t_conversationalemployeeforeignlanguage,string t_languagecertifiedin  )
        {
			int pagesize = 50;
			if (HostingEntityName == "T_Employee")
            {
...
//ManyToMany search in m.m
			if (t_conversationalemployeeforeignlanguage != null)
            {
   			 ...
   			 foreach (var str in ids)
                {
                    ...
                    if (!string.IsNullOrEmpty(str))
                    {
                        ...
                        ids1.AddRange(db.T_ConversationalEmployeeForeignLanguages.Where(p=>p.T_EmployeeID ==idvalue).Select(p=>p.T_LangaugeID));
                        }
                    }
                    //
                }
			...
			if (t_languagecertifiedin != null)
            {
   			 ...
   			 foreach (var str in ids)
                {
                    ...
                    if (!string.IsNullOrEmpty(str))
                    {
                        ...
                        {
                        var idvalue= Convert.ToInt64(str);
                        ids1.AddRange(db.T_LanguageCertifiedIns.Where(p=>p.T_EmployeeID ==idvalue).Select(p=>p.T_LangaugeID));
                        }
                    }
                    //
                }
        ...
        var Finallist = _fad.FilterDropdown<T_Employee>(User, db.T_Employees.Where(p => !Selectedlist.Contains(p.Id)), "T_Employee", "T_ConversationalEmployeeForeignLanguage.T_EmployeeID").ToList();
				...
				if (t_employeeatfacility != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeAtFacilityID)).ToList();
                }
				if (t_employeestatus != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeStatusID)).ToList();
                }
				if (t_currentemployeeemploymentprofile != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_CurrentEmployeeEmploymentProfileID)).ToList();
                }
				if (t_currentemployeejobassignment != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_CurrentEmployeeJobAssignmentID)).ToList();
                }
				if (t_employeegender != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeGenderID)).ToList();
                }
				if (t_employeerace != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeRaceID)).ToList();
                }
				if (t_employeenationalityassociation != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeNationalityAssociationID)).ToList();
                }
				if (t_employeeveteranstatus != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeVeteranStatusID)).ToList();
                }
				if (t_employeecardemplgrpassociation != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeCardEmplGrpAssociationID)).ToList();
                }
				if (t_employeecardlvplanassociation != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeCardLvPlanAssociationID)).ToList();
                }
				if (t_employeeaddress != null)
                {
                    ...
                    ids1 = ids1.ToList();
                    Finallist = Finallist.Where(p => ids1.Contains(p.T_EmployeeAddressID)).ToList();
                }
...
[AcceptVerbs(HttpVerbs.Get)]
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
				try
                {
					...
					if (AssoID != null && AssoID > 0)
					{
						...
						MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
						IQueryable q = query.Provider.CreateQuery(methodCall);
						list = ((IQueryable<T_ConversationalEmployeeForeignLanguage>)q).Take(20);
					}
				}
				catch
                {
        ...
        public JsonResult GetAllMultiSelectValueForBR(string propNameBR)
        {
            ...
            if (!string.IsNullOrEmpty(propNameBR))
            {
				...
				//
                ParameterExpression param = Expression.Parameter(typeof(T_ConversationalEmployeeForeignLanguage), "d");
                //bulid expression tree:data.Field1
                var Property = typeof(T_ConversationalEmployeeForeignLanguage).GetProperty(propNameBR);
                ...
                if (targetType.GetGenericArguments().Count() > 0)
                {
                    if (targetType.GetGenericArguments()[0].Name == "DateTime")
                    {
                        ...
                        new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(DateTime?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                if (targetType.IsGenericType && targetType.GetGenericTypeDefinition() == typeof(Nullable<>))
                {
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(decimal?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(bool?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(Int32?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(Int64?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(double?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                {
                    Expression expr = Expression.Call(typeof(Queryable), "Select",
                            new Type[] { typeof(T_ConversationalEmployeeForeignLanguage), typeof(string) }, Expression.Constant(list.AsQueryable()), pred);
        ...
        public JsonResult GetAllMultiSelectValue(string key, string AssoNameWithParent, string AssociationID)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                paramList.Add(Expression.Parameter(typeof(T_ConversationalEmployeeForeignLanguage), "p"));
			...
			FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
            list = _fad.FilterDropdown<T_ConversationalEmployeeForeignLanguage>(User, list, "T_ConversationalEmployeeForeignLanguage", null);
			if (key != null && key.Length > 0)
            {
			   var data = from x in list.Where(p=>p.DisplayValue.Contains(key)).OrderBy(q=>q.DisplayValue).Take(10).ToList()
                           select new { Id = x.Id, Name = x.DisplayValue };
        ...
        public ActionResult Upload()
        {
			...
			if (!((CustomPrincipal)User).CanUseVerb("ImportExcel", "T_ConversationalEmployeeForeignLanguage", User) || !User.CanAdd("T_ConversationalEmployeeForeignLanguage"))
            {
                return RedirectToAction("Index", "Error");
            }
            //ViewBag.IsMapping = (db.ImportConfigurations.Where(p => p.Name == "T_ConversationalEmployeeForeignLanguage")).Count() > 0 ? true : false;
            var lstMappings = db.ImportConfigurations.Where(p => p.Name == "T_ConversationalEmployeeForeignLanguage").ToList();
         ...
         public ActionResult Upload([Bind(Include = "FileUpload")] HttpPostedFileBase FileUpload, FormCollection collection)
        {
            if (FileUpload != null)
            {
                ...
                if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv" || fileExtension == ".all")
                {
                    ...
                    var entList = GeneratorBase.MVC.ModelReflector.Entities.FirstOrDefault(e => e.Name == "T_ConversationalEmployeeForeignLanguage");
                    if (entList != null)
                    {
					...
					if (!string.IsNullOrEmpty(collection["ListOfMappings"]))
                    {
                        ...
                        string colDisKey = "";
                        string colListInx = "";
                        typeName = "T_ConversationalEmployeeForeignLanguage";
                        ...
                        {
                            var lstMapping = db.ImportConfigurations.Where(p => p.Name == "T_ConversationalEmployeeForeignLanguage" && p.IsDefaultMapping);
                        ...
                        DetailMessage = "We have received " + objDataSet.Tables[0].Rows.Count + " new Conversational Employee Foreign Languages";
                        ...
                        if (entList != null)
                        {
                            ...
                            foreach (var association in entList.Associations)
                            {
                                ...
                                for (int i = 0; i < uniqueCols.Rows.Count; i++)
                                {
                                    ...
                                    {
                                										 case "T_EmployeeID":
										 var t_employeeId = db.T_Employees.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_employeeId == null)
											uniqueassoValues.Add(assovalue);
										 break;
																		 case "T_LangaugeID":
										 var t_langaugeId = db.T_Langauges.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_langaugeId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                        default:
                                            break;
        ...
        public ActionResult ConfirmImportData(FormCollection collection)
        {
            ...
            string excelConnectionString = string.Empty;
			string typename = "T_ConversationalEmployeeForeignLanguage";
                ...
                if (entList != null)
                {
                    ...
                    foreach (var association in entList.Associations)
                    {
                        ...
                        for (int i = 0; i < uniqueCols.Rows.Count; i++)
                        {
                            ...
                            {
                                										 case "T_EmployeeID":
										 var strPropertyT_Employee = lstEntityProp.FirstOrDefault(p => p.Key == "T_EmployeeID").Value;
										 ModelReflector.Property propT_Employee = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_Employee").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_Employee);
										 //var elementTypeT_Employee = db.T_Employees.ElementType;
										 //var propertyInfoT_Employee = elementTypeT_Employee.GetProperty(propT_Employee.Name);
										 // var t_employeeId = db.T_Employees.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_Employee.GetValue(p, null)) == assovalue);
										 var t_employeeId = db.T_Employees.Where(propT_Employee.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_employeeId == null)
											uniqueassoValues.Add(assovalue);
										 break;
																		 case "T_LangaugeID":
										 var strPropertyT_Langauge = lstEntityProp.FirstOrDefault(p => p.Key == "T_LangaugeID").Value;
										 ModelReflector.Property propT_Langauge = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_Langauge").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_Langauge);
										 //var elementTypeT_Langauge = db.T_Langauges.ElementType;
										 //var propertyInfoT_Langauge = elementTypeT_Langauge.GetProperty(propT_Langauge.Name);
										 // var t_langaugeId = db.T_Langauges.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_Langauge.GetValue(p, null)) == assovalue);
										 var t_langaugeId = db.T_Langauges.Where(propT_Langauge.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_langaugeId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                default:
        ...
        public ActionResult ImportData(FormCollection collection)
        {
            ...
            if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv")
            {
                ...
                if (selectedlist != null && columnlist != null)
                {
                    for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (AreAllColumnsEmpty(objDataSet.Tables[0].Rows[i], sheetColumns))
                            continue;
                        T_ConversationalEmployeeForeignLanguage model = new T_ConversationalEmployeeForeignLanguage();
		 ...
		 if(lstEntityProp.Count > 0)
		 {
			 ...
			 //var elementTypeT_Employee = db.T_Employees.ElementType;
			 //var propertyInfoT_Employee = elementTypeT_Employee.GetProperty(propT_Employee.Name);			 
			 //t_employeeId = db.T_Employees.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_Employee.GetValue(p, null)) == columnValue);
			 t_employeeId = db.T_Employees.Where(propT_Employee.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_employeeId = db.T_Employees.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_employeeId != null)
			model.T_EmployeeID = t_employeeId.Id;
		  else
			{
				if ((collection["T_EmployeeID"].ToString() == "true,false"))
				{
					try
					{
				 ...
				 try { objT_Employee.T_FirstName =(columnValue); }
						...
						db.SaveChanges();
						model.T_EmployeeID = objT_Employee.Id;
					}
					catch
					{
						continue;
		 ...
		 if(lstEntityProp.Count > 0)
		 {
			 ...
			 //var elementTypeT_Langauge = db.T_Langauges.ElementType;
			 //var propertyInfoT_Langauge = elementTypeT_Langauge.GetProperty(propT_Langauge.Name);			 
			 //t_langaugeId = db.T_Langauges.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_Langauge.GetValue(p, null)) == columnValue);
			 t_langaugeId = db.T_Langauges.Where(propT_Langauge.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_langaugeId = db.T_Langauges.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_langaugeId != null)
			model.T_LangaugeID = t_langaugeId.Id;
		  else
			{
				if ((collection["T_LangaugeID"].ToString() == "true,false"))
				{
					try
					{
						T_Langauge objT_Langauge = new T_Langauge();
						objT_Langauge.T_Name  = (columnValue);
						db.T_Langauges.Add(objT_Langauge);
						db.SaveChanges();
						model.T_LangaugeID = objT_Langauge.Id;
					}
					catch
					{
						continue;
                ...
                break;
					    ...
					    if (ValidateModel(model))
                        {
                            ...
                            if (result == null || result.Count == 0)
                            {
								...
								{
									db.T_ConversationalEmployeeForeignLanguages.Add(model);
									db.SaveChanges();
								}
								error += customerror;
							}
		...
		public bool ValidateModel(T_ConversationalEmployeeForeignLanguage validate)
        {
		...
		public object GetFieldValueByEntityId(long Id, string PropName)
        {
            ...
            {
			                ApplicationContext db1 = new ApplicationContext(new SystemUser());
                var obj1 = db1.T_ConversationalEmployeeForeignLanguages.Find(Id);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetReadOnlyProperties(T_ConversationalEmployeeForeignLanguage OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            if (User.businessrules != null)
            {
                var BR = User.businessrules.Where(p => p.EntityName == "T_ConversationalEmployeeForeignLanguage").ToList();
                var BRAll = BR;
                if (BR != null && BR.Count > 0)
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.ReadOnlyPropertiesRule(OModel, BR, "T_ConversationalEmployeeForeignLanguage");
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetMandatoryProperties(T_ConversationalEmployeeForeignLanguage OModel, string ruleType)
        {
            ...
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
					...
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.MandatoryPropertiesRule(OModel, BR, "T_ConversationalEmployeeForeignLanguage");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetUIAlertBusinessRules(T_ConversationalEmployeeForeignLanguage OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.UIAlertRule(OModel, BR, "T_ConversationalEmployeeForeignLanguage");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetValidateBeforeSaveProperties(T_ConversationalEmployeeForeignLanguage OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.ValidateBeforeSavePropertiesRule(OModel, BR, "T_ConversationalEmployeeForeignLanguage",state);
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetLockBusinessRules(T_ConversationalEmployeeForeignLanguage OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            //string RulesApplied = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.LockEntityRule(OModel, BR, "T_ConversationalEmployeeForeignLanguage");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		private List<string> CheckMandatoryProperties(T_ConversationalEmployeeForeignLanguage OModel)
        {
                ...
                if (BR != null && BR.Count > 0)
                {
                    ...
                    if (ResultOfBusinessRules.Keys.Select(p=>p.TypeNo).Contains(2))
                    {
                        ...
                        foreach (string paramName in Args.Select(p => p.ParameterName))
                        {
                            ...
                            {
                                var dispName = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_ConversationalEmployeeForeignLanguage").Properties.FirstOrDefault(p => p.Name == paramName).DisplayName;
                                result.Add(dispName);
                            }
                        }
                    }
		...
		public long? GetIdFromDisplayValue(string displayvalue)
        {
            ...
            var _Obj = db1.T_ConversationalEmployeeForeignLanguages.FirstOrDefault(p => p.DisplayValue == displayvalue);
            long outValue;
            if (_Obj != null)
        ...
        {
            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            IQueryable query = db1.T_ConversationalEmployeeForeignLanguages;
            Type[] exprArgTypes = { query.ElementType };
            ...
            lambda = Expression.Lambda<Func<T_ConversationalEmployeeForeignLanguage, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(PropValue), member.Type)), p);
            else
                lambda = Expression.Lambda<Func<T_ConversationalEmployeeForeignLanguage, bool>>(Expression.Equal(member, Expression.Constant(null, member.Type)), p);
            MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
            IQueryable q = query.Provider.CreateQuery(methodCall);
            long outValue;
            var list1 = ((IQueryable<T_ConversationalEmployeeForeignLanguage>)q);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult Check1MThresholdValue(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage)
        {
        ...
        public ActionResult GetCalculationValues(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage)
        {
            t_conversationalemployeeforeignlanguage.setCalculation();
            Dictionary<string, string> Calculations = new Dictionary<string, string>();
            System.Reflection.PropertyInfo[] properties = (t_conversationalemployeeforeignlanguage.GetType()).GetProperties().Where(p => p.PropertyType.FullName.StartsWith("System")).ToArray();
        ...
        public void GetTemplatesForList(string defaultview)
        {
            ...
            var lstDefaultEntityPage = from s in db.DefaultEntityPages
                                       where s.EntityName == "T_ConversationalEmployeeForeignLanguage"
                                       select s;
	...
	[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetails(T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage, string IgnoreEditable)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetailsInline(string host, string value, T_ConversationalEmployeeForeignLanguage t_conversationalemployeeforeignlanguage, string IgnoreEditable)
        {
            Dictionary<string, string> derivedlist = new Dictionary<string, string>();
            return Json(derivedlist, "application/json", System.Text.Encoding.UTF8, JsonRequestBehavior.AllowGet);
        }
