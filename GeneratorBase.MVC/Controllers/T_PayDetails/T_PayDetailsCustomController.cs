...
{	
    ...
    {
		public bool CheckBeforeDelete(T_PayDetails t_paydetails)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_PayDetails t_paydetails, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_PayDetails t_paydetails)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_PayDetails t_paydetails, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_PayDetails t_paydetails)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_PayDetails t_paydetails)
{
}
private void CustomLoadViewDataListBeforeEdit(T_PayDetails t_paydetails)
{
}
private void CustomLoadViewDataListAfterEdit(T_PayDetails t_paydetails)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_PayDetails t_paydetails, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_PayDetails t_paydetails, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_PayDetails t_paydetails, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_PayDetails t_paydetails, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_PayDetails> CustomSorting(IQueryable<T_PayDetails> list)
{
    IQueryable<T_PayDetails> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_PayDetails t_paydetails,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_PayDetails");
    return null;
}
	}
}
