...
{	
    public partial class T_StateController : BaseController
    {
		...
		public string CheckBeforeSave(T_State t_state, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_State t_state)
{
}
private void CustomLoadViewDataListBeforeEdit(T_State t_state)
{
}
private void CustomLoadViewDataListAfterEdit(T_State t_state)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_State t_state, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_State t_state, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_State t_state, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_State t_state, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_State> CustomSorting(IQueryable<T_State> list)
{
    IQueryable<T_State> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_State t_state,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_State");
    return null;
}
	}
}
