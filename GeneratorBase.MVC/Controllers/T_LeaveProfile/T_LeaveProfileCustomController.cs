...
{	
    ...
    {
		public bool CheckBeforeDelete(T_LeaveProfile t_leaveprofile)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_LeaveProfile t_leaveprofile, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_LeaveProfile t_leaveprofile)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_LeaveProfile t_leaveprofile, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_LeaveProfile t_leaveprofile)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_LeaveProfile t_leaveprofile)
{
}
private void CustomLoadViewDataListBeforeEdit(T_LeaveProfile t_leaveprofile)
{
}
private void CustomLoadViewDataListAfterEdit(T_LeaveProfile t_leaveprofile)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_LeaveProfile t_leaveprofile, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_LeaveProfile t_leaveprofile, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_LeaveProfile t_leaveprofile, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_LeaveProfile t_leaveprofile, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_LeaveProfile> CustomSorting(IQueryable<T_LeaveProfile> list)
{
    IQueryable<T_LeaveProfile> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_LeaveProfile t_leaveprofile,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_LeaveProfile");
    return null;
}
	}
}
