...
{	
    ...
    {
		public bool CheckBeforeDelete(T_FacilityUser t_facilityuser)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_FacilityUser t_facilityuser, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_FacilityUser t_facilityuser)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_FacilityUser t_facilityuser, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_FacilityUser t_facilityuser)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_FacilityUser t_facilityuser)
{
}
private void CustomLoadViewDataListBeforeEdit(T_FacilityUser t_facilityuser)
{
}
private void CustomLoadViewDataListAfterEdit(T_FacilityUser t_facilityuser)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_FacilityUser t_facilityuser, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_FacilityUser t_facilityuser, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_FacilityUser t_facilityuser, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_FacilityUser t_facilityuser, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_FacilityUser> CustomSorting(IQueryable<T_FacilityUser> list)
{
    IQueryable<T_FacilityUser> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_FacilityUser t_facilityuser,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_FacilityUser");
    return null;
}
	}
}
