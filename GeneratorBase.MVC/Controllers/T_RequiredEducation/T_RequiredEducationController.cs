...
{	
    public partial class T_RequiredEducationController : BaseController
    {
		private void LoadViewDataForCount(T_RequiredEducation t_requirededucation, string AssocType)
        {
        }
		private void LoadViewDataAfterOnEdit(T_RequiredEducation t_requirededucation)
        {		
			 ViewBag.T_RoleCodeRequiredEducationID = new SelectList(db.T_RoleCodes, "ID", "DisplayValue", t_requirededucation.T_RoleCodeRequiredEducationID);
			 ViewBag.T_RequiredEducationSOCCodeID = new SelectList(db.T_SocCodes, "ID", "DisplayValue", t_requirededucation.T_RequiredEducationSOCCodeID);
			 ViewBag.T_RequiredEducationEducationLevelID = new SelectList(db.T_EducationLevels, "ID", "DisplayValue", t_requirededucation.T_RequiredEducationEducationLevelID);
			CustomLoadViewDataListAfterEdit(t_requirededucation);
        }
        private void LoadViewDataBeforeOnEdit(T_RequiredEducation t_requirededucation)
        {		
               var _objT_RoleCodeRequiredEducation = new List<T_RoleCode>();
               _objT_RoleCodeRequiredEducation.Add(t_requirededucation.t_rolecoderequirededucation);
			   			   ViewBag.T_RoleCodeRequiredEducationID = new SelectList(_objT_RoleCodeRequiredEducation, "ID", "DisplayValue", t_requirededucation.T_RoleCodeRequiredEducationID);
			               var _objT_RequiredEducationSOCCode = new List<T_SocCode>();
               _objT_RequiredEducationSOCCode.Add(t_requirededucation.t_requirededucationsoccode);
			   			   ViewBag.T_RequiredEducationSOCCodeID = new SelectList(_objT_RequiredEducationSOCCode, "ID", "DisplayValue", t_requirededucation.T_RequiredEducationSOCCodeID);
			               var _objT_RequiredEducationEducationLevel = new List<T_EducationLevel>();
               _objT_RequiredEducationEducationLevel.Add(t_requirededucation.t_requirededucationeducationlevel);
			   			   ViewBag.T_RequiredEducationEducationLevelID = new SelectList(_objT_RequiredEducationEducationLevel, "ID", "DisplayValue", t_requirededucation.T_RequiredEducationEducationLevelID);
					CustomLoadViewDataListBeforeEdit(t_requirededucation);
        }
        private void LoadViewDataAfterOnCreate(T_RequiredEducation t_requirededucation)
        {			
			 ViewBag.T_RoleCodeRequiredEducationID = new SelectList(db.T_RoleCodes, "ID", "DisplayValue", t_requirededucation.T_RoleCodeRequiredEducationID);
			 ViewBag.T_RequiredEducationSOCCodeID = new SelectList(db.T_SocCodes, "ID", "DisplayValue", t_requirededucation.T_RequiredEducationSOCCodeID);
			 ViewBag.T_RequiredEducationEducationLevelID = new SelectList(db.T_EducationLevels, "ID", "DisplayValue", t_requirededucation.T_RequiredEducationEducationLevelID);
		CustomLoadViewDataListAfterOnCreate(t_requirededucation);
        }
        private void LoadViewDataBeforeOnCreate(string HostingEntityName, string HostingEntityID, string AssociatedType)
        {			
			if(HostingEntityName == "T_RoleCode" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_RoleCodeRequiredEducation")
			{
			    var hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_RoleCodeRequiredEducationID = new SelectList(db.T_RoleCodes.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_RoleCodes.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{
			var objT_RoleCodeRequiredEducation = new List<T_RoleCode>();
			 ViewBag.T_RoleCodeRequiredEducationID = new SelectList(objT_RoleCodeRequiredEducation , "ID", "DisplayValue");
		    }
			if(HostingEntityName == "T_SocCode" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_RequiredEducationSOCCode")
			{
			    var hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_RequiredEducationSOCCodeID = new SelectList(db.T_SocCodes.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_SocCodes.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{
			var objT_RequiredEducationSOCCode = new List<T_SocCode>();
			 ViewBag.T_RequiredEducationSOCCodeID = new SelectList(objT_RequiredEducationSOCCode , "ID", "DisplayValue");
		    }
			if(HostingEntityName == "T_EducationLevel" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_RequiredEducationEducationLevel")
			{
			    var hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_RequiredEducationEducationLevelID = new SelectList(db.T_EducationLevels.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_EducationLevels.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{
			var objT_RequiredEducationEducationLevel = new List<T_EducationLevel>();
			 ViewBag.T_RequiredEducationEducationLevelID = new SelectList(objT_RequiredEducationEducationLevel , "ID", "DisplayValue");
		    }
			CustomLoadViewDataListBeforeOnCreate(HostingEntityName, HostingEntityID, AssociatedType);
        }
		private IQueryable<T_RequiredEducation> searchRecords(IQueryable<T_RequiredEducation> lstT_RequiredEducation, string searchString, bool? IsDeepSearch)
        {
		   searchString = searchString.Trim();
		if(Convert.ToBoolean(IsDeepSearch))
            lstT_RequiredEducation = lstT_RequiredEducation.Where(s => (s.t_rolecoderequirededucation!= null && (s.t_rolecoderequirededucation.DisplayValue.ToUpper().Contains(searchString) )) ||(s.t_requirededucationsoccode!= null && (s.t_requirededucationsoccode.DisplayValue.ToUpper().Contains(searchString) )) ||(s.t_requirededucationeducationlevel!= null && (s.t_requirededucationeducationlevel.DisplayValue.ToUpper().Contains(searchString) )) ||(!String.IsNullOrEmpty(s.T_Description) && s.T_Description.ToUpper().Contains(searchString)) ||(!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
		else
			 lstT_RequiredEducation = lstT_RequiredEducation.Where(s => (s.t_rolecoderequirededucation!= null && (s.t_rolecoderequirededucation.DisplayValue.ToUpper().Contains(searchString) )) ||(s.t_requirededucationsoccode!= null && (s.t_requirededucationsoccode.DisplayValue.ToUpper().Contains(searchString) )) ||(s.t_requirededucationeducationlevel!= null && (s.t_requirededucationeducationlevel.DisplayValue.ToUpper().Contains(searchString) )) ||(!String.IsNullOrEmpty(s.T_Description) && s.T_Description.ToUpper().Contains(searchString)) ||(!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
            return lstT_RequiredEducation;
        }
		private IQueryable<T_RequiredEducation> sortRecords(IQueryable<T_RequiredEducation> lstT_RequiredEducation, string sortBy, string isAsc)
        {
            string methodName = "";
	 ...
	 if(sortBy == "T_RoleCodeRequiredEducationID")
                return isAsc.ToLower() == "asc" ? lstT_RequiredEducation.OrderBy(p => p.t_rolecoderequirededucation.DisplayValue) : lstT_RequiredEducation.OrderByDescending(p => p.t_rolecoderequirededucation.DisplayValue);
	 if(sortBy == "T_RequiredEducationSOCCodeID")
                return isAsc.ToLower() == "asc" ? lstT_RequiredEducation.OrderBy(p => p.t_requirededucationsoccode.DisplayValue) : lstT_RequiredEducation.OrderByDescending(p => p.t_requirededucationsoccode.DisplayValue);
	 if(sortBy == "T_RequiredEducationEducationLevelID")
                return isAsc.ToLower() == "asc" ? lstT_RequiredEducation.OrderBy(p => p.t_requirededucationeducationlevel.DisplayValue) : lstT_RequiredEducation.OrderByDescending(p => p.t_requirededucationeducationlevel.DisplayValue);
		    if (sortBy.Contains("."))
                return isAsc.ToLower() == "asc" ? lstT_RequiredEducation.Sort(sortBy,true) : lstT_RequiredEducation.Sort(sortBy,false);
            ParameterExpression paramExpression = Expression.Parameter(typeof(T_RequiredEducation), "t_requirededucation");
            MemberExpression memExp = Expression.PropertyOrField(paramExpression, sortBy);
            LambdaExpression lambda = Expression.Lambda(memExp, paramExpression);
            return (IQueryable<T_RequiredEducation>)lstT_RequiredEducation.Provider.CreateQuery(
                Expression.Call(
                    typeof(Queryable),
                    methodName,
                    new Type[] { lstT_RequiredEducation.ElementType, lambda.Body.Type },
                    lstT_RequiredEducation.Expression,
                    lambda));
        }
		public ActionResult FindFSearch(string id, string sourceEntity)
        {
            if (sourceEntity == "T_Position")
            {
                ...
                url += "?search=";
						var T_RoleCodeRequiredEducation  = _Object.T_PositionRoleCodeID;
						url += "&t_rolecoderequirededucation=" + T_RoleCodeRequiredEducation;									
						var T_RequiredEducationSOCCode  = _Object.T_PositionSOCCodeID;
						url += "&t_requirededucationsoccode=" + T_RequiredEducationSOCCode;									
            ...
            if (sourceEntity == "T_Education")
            {
                ...
                url += "?search=";
						var T_RequiredEducationEducationLevel  = _Object.T_LevelOfEducationID;
						url += "&t_requirededucationeducationlevel=" + T_RequiredEducationEducationLevel;									
                Response.Redirect(url.ToString());
            }
            return null;
        }
        public ActionResult SetFSearch(string searchString, string HostingEntity ,string t_rolecoderequirededucation,string t_requirededucationsoccode,string t_requirededucationeducationlevel, bool? RenderPartial)
        {
			int Qcount = 0;
			...
			if(Qcount > 0)
			{
			var T_RoleCodeRequiredEducationlist = db.T_RoleCodes.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_rolecoderequirededucation != null)
            {
                var ids = t_rolecoderequirededucation.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n Role Code= ";
				   foreach (var str in ids)
					...
					ids1 = ids1.ToList();
					var list = T_RoleCodeRequiredEducationlist.Union(db.T_RoleCodes.Where(p=>ids1.Contains(p.Id))).Distinct();
					FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
					list = _fad.FilterDropdown<T_RoleCode>(User, list, "T_RoleCode", null);
					ViewBag.t_rolecoderequirededucation = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				var list = T_RoleCodeRequiredEducationlist;
				FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
				list = _fad.FilterDropdown<T_RoleCode>(User, list, "T_RoleCode", null);
				ViewBag.t_rolecoderequirededucation = new SelectList(list, "ID", "DisplayValue");
			}
			var T_RequiredEducationSOCCodelist = db.T_SocCodes.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_requirededucationsoccode != null)
            {
                var ids = t_requirededucationsoccode.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n SOC Code= ";
				   foreach (var str in ids)
                    {
					...
					ids1 = ids1.ToList();
					var list = T_RequiredEducationSOCCodelist.Union(db.T_SocCodes.Where(p=>ids1.Contains(p.Id))).Distinct();
					FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
					list = _fad.FilterDropdown<T_SocCode>(User, list, "T_SocCode", null);
					ViewBag.t_requirededucationsoccode = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				var list = T_RequiredEducationSOCCodelist;
				FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
				list = _fad.FilterDropdown<T_SocCode>(User, list, "T_SocCode", null);
				ViewBag.t_requirededucationsoccode = new SelectList(list, "ID", "DisplayValue");
			}
			var T_RequiredEducationEducationLevellist = db.T_EducationLevels.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_requirededucationeducationlevel != null)
            {
                var ids = t_requirededucationeducationlevel.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n Education Level= ";
				   foreach (var str in ids)
                    {
					...
					ids1 = ids1.ToList();
					var list = T_RequiredEducationEducationLevellist.Union(db.T_EducationLevels.Where(p=>ids1.Contains(p.Id))).Distinct();
					FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
					list = _fad.FilterDropdown<T_EducationLevel>(User, list, "T_EducationLevel", null);
					ViewBag.t_requirededucationeducationlevel = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				var list = T_RequiredEducationEducationLevellist;
				FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
				list = _fad.FilterDropdown<T_EducationLevel>(User, list, "T_EducationLevel", null);
				ViewBag.t_requirededucationeducationlevel = new SelectList(list, "ID", "DisplayValue");
			}
			...
			{
			var objT_RoleCodeRequiredEducation = new List<T_RoleCode>();
		    ViewBag.t_rolecoderequirededucation = new SelectList(objT_RoleCodeRequiredEducation, "ID", "DisplayValue");
			var objT_RequiredEducationSOCCode = new List<T_SocCode>();
		    ViewBag.t_requirededucationsoccode = new SelectList(objT_RequiredEducationSOCCode, "ID", "DisplayValue");
			var objT_RequiredEducationEducationLevel = new List<T_EducationLevel>();
		    ViewBag.t_requirededucationeducationlevel = new SelectList(objT_RequiredEducationEducationLevel, "ID", "DisplayValue");
			}
				...
				ViewBag.EntityName = "T_RequiredEducation";
			...
			columns.Add("2", "Role Code");
			columns.Add("3", "SOC Code");
			columns.Add("4", "Education Level");
			columns.Add("5", "Education Details");
				ViewBag.HideColumns = new MultiSelectList(columns, "Key", "Value");
				return View(new T_RequiredEducation());
            }
		public string conditionFSearch(string property, string operators, string value)
        {
            string expression = string.Empty;
            var PrpertyType = GetDataTypeOfProperty("T_RequiredEducation", property);
            var dataType = PrpertyType[0];
            property = PrpertyType[1];
            if (value.StartsWith("[") && value.EndsWith("]"))
            {
                var ValueType = GetDataTypeOfProperty("T_RequiredEducation", value, true);
                ...
                case "DateTime":
                    {
					   ...
					   {
							expression = string.Format(" DbFunctions.TruncateTime(" + property + ") " + operators + " (\"{0}\")", (TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, (new T_RequiredEducation()).m_Timezone)).Date);
						}
						else
						{
		...
		// GET: /T_RequiredEducation/FSearch/
		[Audit("FacetedSearch")]
		public ActionResult FSearch(string currentFilter, string searchString, string FSFilter, string sortBy, string isAsc, int? page, int? itemsPerPage, string search, bool? IsExport ,string t_rolecoderequirededucation,string t_requirededucationsoccode,string t_requirededucationeducationlevel ,string FilterCondition, string HostingEntity, string AssociatedType,string HostingEntityID, string viewtype, string SortOrder, string HideColumns, string GroupByColumn,bool? IsReports, bool? IsdrivedTab)
        {
            ...
            if (!string.IsNullOrEmpty(searchString) && FSFilter == null)
                ViewBag.FSFilter = "Fsearch";
				 var lstT_RequiredEducation  = from s in db.T_RequiredEducations
                           select s;
            if (!String.IsNullOrEmpty(searchString))
            {
                lstT_RequiredEducation  = searchRecords(lstT_RequiredEducation, searchString.ToUpper(),true);
            }
			  if(!string.IsNullOrEmpty(search))
                	search=search.Replace("?IsAddPop=true", "");
			if(!string.IsNullOrEmpty(search)){
				ViewBag.SearchResult += "\r\n General Criterial= "+search;
				lstT_RequiredEducation = searchRecords(lstT_RequiredEducation, search,true);
			}
            if (!String.IsNullOrEmpty(sortBy) && !String.IsNullOrEmpty(isAsc))
            {
                lstT_RequiredEducation  = sortRecords(lstT_RequiredEducation, sortBy, isAsc);
            }
            else   lstT_RequiredEducation  = lstT_RequiredEducation.OrderByDescending(c => c.Id);
			lstT_RequiredEducation = CustomSorting(lstT_RequiredEducation);
			lstT_RequiredEducation = lstT_RequiredEducation.Include(t=>t.t_rolecoderequirededucation).Include(t=>t.t_requirededucationsoccode).Include(t=>t.t_requirededucationeducationlevel);
			if (!string.IsNullOrEmpty(FilterCondition))
            {
                ...
                foreach (var cond in conditions)
                {
                    ...
                    if (iCnt == conditions.Count())
                        LogicalConnector = "";
					ViewBag.SearchResult += " " + GetPropertyDP("T_RequiredEducation", PropertyName) + " " + Operator + " " + Value + " " + LogicalConnector;
                    whereCondition.Append(conditionFSearch(PropertyName, Operator, Value) + LogicalConnector);
                    iCnt++;
                }
                if (!string.IsNullOrEmpty(whereCondition.ToString()))
                    lstT_RequiredEducation = lstT_RequiredEducation.Where(whereCondition.ToString());
            ...
            if (!string.IsNullOrEmpty(DataOrdering))
                lstT_RequiredEducation = Sorting.Sort<T_RequiredEducation>(lstT_RequiredEducation, DataOrdering);
            var _T_RequiredEducation = lstT_RequiredEducation;
			//if (lstT_RequiredEducation.Where(p => p.t_rolecoderequirededucation != null).Count() <= 50)
		    //ViewBag.t_rolecoderequirededucation = new SelectList(lstT_RequiredEducation.Where(p => p.t_rolecoderequirededucation != null).Select(P => P.t_rolecoderequirededucation).Distinct(), "ID", "DisplayValue");
            if (t_rolecoderequirededucation != null)
            {
                var ids = t_rolecoderequirededucation.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
                ...
                ids1 = ids1.ToList();
                _T_RequiredEducation = _T_RequiredEducation.Where(p => ids1.Contains(p.T_RoleCodeRequiredEducationID));
            }
				//if (lstT_RequiredEducation.Where(p => p.t_requirededucationsoccode != null).Count() <= 50)
		    //ViewBag.t_requirededucationsoccode = new SelectList(lstT_RequiredEducation.Where(p => p.t_requirededucationsoccode != null).Select(P => P.t_requirededucationsoccode).Distinct(), "ID", "DisplayValue");
            if (t_requirededucationsoccode != null)
            {
                var ids = t_requirededucationsoccode.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
                ...
                ids1 = ids1.ToList();
                _T_RequiredEducation = _T_RequiredEducation.Where(p => ids1.Contains(p.T_RequiredEducationSOCCodeID));
            }
				//if (lstT_RequiredEducation.Where(p => p.t_requirededucationeducationlevel != null).Count() <= 50)
		    //ViewBag.t_requirededucationeducationlevel = new SelectList(lstT_RequiredEducation.Where(p => p.t_requirededucationeducationlevel != null).Select(P => P.t_requirededucationeducationlevel).Distinct(), "ID", "DisplayValue");
            if (t_requirededucationeducationlevel != null)
            {
                var ids = t_requirededucationeducationlevel.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
                ...
                ids1 = ids1.ToList();
                _T_RequiredEducation = _T_RequiredEducation.Where(p => ids1.Contains(p.T_RequiredEducationEducationLevelID));
            }
				if (!string.IsNullOrEmpty(SortOrder))
            {
                ViewBag.SearchResult += " \r\n Sort Order = ";
                ...
                var Entity = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_RequiredEducation");
		   ...
		   if (itemsPerPage != null)
            ...
            if (Request.Cookies["pageSize" + HttpUtility.UrlEncode(User.Name) + "T_RequiredEducation"] != null)
            {
                pageSize = Convert.ToInt32(Request.Cookies["pageSize" + HttpUtility.UrlEncode(User.Name) + "T_RequiredEducation"].Value);
                ViewBag.CurrentItemsPerPage = itemsPerPage;
            }
            ...
            {
                pageNumber = 1;
                if (_T_RequiredEducation.Count() > 0)
                    pageSize = _T_RequiredEducation.Count();
                return View("ExcelExport", _T_RequiredEducation.ToPagedList(pageNumber, pageSize));
            }
			else
            {
			 if (pageNumber > 1)
			 {
                var totalListCount = _T_RequiredEducation.Count();
			...
			if (!Request.IsAjaxRequest())
			{
				...
				var list = _T_RequiredEducation.ToPagedList(pageNumber, pageSize);
				ViewBag.EntityT_RequiredEducationDisplayValue = new SelectList(list.Select(z => new { ID = z.Id, DisplayValue = z.DisplayValue }), "ID", "DisplayValue");
				TempData["T_RequiredEducationlist"] = list.Select(z => new { ID = z.Id, DisplayValue = z.DisplayValue });
				if (!string.IsNullOrEmpty(GroupByColumn))
                    foreach (var item in list)
                    {
                        var tagsSplit = GroupByColumn.Split(',').Select(tag => tag.Trim()).Where(tag => !string.IsNullOrEmpty(tag));
                        item.m_DisplayValue = EntityComparer.GetGroupByDisplayValue(item, "T_RequiredEducation", tagsSplit.ToArray());
                    }
		...
		var entity = "T_RequiredEducation";
           ...
           var entitylist = db.T_RequiredEducations;
		...
		public string ShowGraph1(string type, int? inlarge)
        {
            string result = "";
           {
                var gd = db.T_RequiredEducations.GroupBy(p => p.t_rolecoderequirededucation.DisplayValue).ToList();
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Column, "", "Role Code", "Required Education"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_RequiredEducation", new { type = "1", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
           ...
           {
                var gd = db.T_RequiredEducations.GroupBy(p => p.t_requirededucationsoccode.DisplayValue).ToList();
                var _xval = gd.Select(k => Convert.ToString(k.Key)).ToList();
				if (type == "2" || type == "all")
                {
                    var cntgrt10 = false;
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Pie, "", "SOC Code", "Required Education"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_RequiredEducation", new { type = "2", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
           ...
           {
                var gd = db.T_RequiredEducations.GroupBy(p => p.t_requirededucationeducationlevel.DisplayValue).ToList();
                var _xval = gd.Select(k => Convert.ToString(k.Key)).ToList();
				if (type == "3" || type == "all")
                {
                    var cntgrt10 = false;
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.BorderSkin.SkinStyle = BorderSkinStyle.Emboss;
				if (cntgrt10)
                chart.Titles.Add(CreateTitle("Count by Education Level (Top 10)"));
				else
				 chart.Titles.Add(CreateTitle("Count by Education Level"));
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Column, "", "Education Level", "Required Education"));
                chart.Series.Add(CreateSeries(SeriesChartType.Column, ""));
                chart.Series[0].Points.DataBindXY(_xval, _yval);
                chart.Legends.Add(CreateLegend(""));
				 if (inlarge != null)
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_RequiredEducation", new { type = "3", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
        ...
        public string GetDisplayValue(string id)
        {
            ...
            var _Obj = db1.T_RequiredEducations.FirstOrDefault(p => p.Id == idvalue);
		...
		var t_requirededucation = jedb.T_RequiredEducations.Find(id);
		...
		public object GetRecordById(string id)
        {
		            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            if (string.IsNullOrEmpty(id)) return "";
            var _Obj = db1.T_RequiredEducations.Find(Convert.ToInt64(id));
            return _Obj;
        }
		public string GetRecordById_Reflection(string id)
        {
			...
			if (string.IsNullOrEmpty(id)) return "";
			var _Obj = db1.T_RequiredEducations.Find(Convert.ToInt64(id));
            return _Obj == null ? "" : EntityComparer.EnumeratePropertyValues<T_RequiredEducation>(_Obj, "T_RequiredEducation", new string[] { ""  }); ;
			        }
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetAllValueForFilter(string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
		            IQueryable<T_RequiredEducation> list = db.T_RequiredEducations;
		...
		public JsonResult GetAllValue(string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                {
                    IQueryable query = db.T_RequiredEducations;
					string lambda = "";
                   ...
                   // ParameterExpression p = Expression.Parameter(typeof(T_RequiredEducation), "p");
                   // MemberExpression member = Expression.PropertyOrField(p, propToWhere);
                   // LambdaExpression lambda = Expression.Lambda<Func<T_RequiredEducation, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(AssoID), member.Type)), p);
                   // MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
                   // IQueryable q = query.Provider.CreateQuery(methodCall);
                   //list = ((IQueryable<T_RequiredEducation>)q);
				   list = ((IQueryable<T_RequiredEducation>)query);
                }
				else if (AssoID == 0)
                {
                   IQueryable query = db.T_RequiredEducations;
			...
			FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
            list = _fad.FilterDropdown<T_RequiredEducation>(User,list, "T_RequiredEducation",caller);
...
[AcceptVerbs(HttpVerbs.Get)]
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
				try
                {
					...
					if (AssoID != null && AssoID > 0)
					{
						...
						MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
						IQueryable q = query.Provider.CreateQuery(methodCall);
						list = ((IQueryable<T_RequiredEducation>)q).Take(20);
					}
				}
				catch
                {
        ...
        public JsonResult GetAllMultiSelectValueForBR(string propNameBR)
        {
            ...
            if (!string.IsNullOrEmpty(propNameBR))
            {
				...
				//
                ParameterExpression param = Expression.Parameter(typeof(T_RequiredEducation), "d");
                //bulid expression tree:data.Field1
                var Property = typeof(T_RequiredEducation).GetProperty(propNameBR);
                ...
                if (targetType.GetGenericArguments().Count() > 0)
                {
                    if (targetType.GetGenericArguments()[0].Name == "DateTime")
                    {
                        ...
                        new Type[] { typeof(T_RequiredEducation), typeof(DateTime?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                if (targetType.IsGenericType && targetType.GetGenericTypeDefinition() == typeof(Nullable<>))
                {
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_RequiredEducation), typeof(decimal?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_RequiredEducation), typeof(bool?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_RequiredEducation), typeof(Int32?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_RequiredEducation), typeof(Int64?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_RequiredEducation), typeof(double?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                {
                    Expression expr = Expression.Call(typeof(Queryable), "Select",
                            new Type[] { typeof(T_RequiredEducation), typeof(string) }, Expression.Constant(list.AsQueryable()), pred);
        ...
        public JsonResult GetAllMultiSelectValue(string key, string AssoNameWithParent, string AssociationID)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                paramList.Add(Expression.Parameter(typeof(T_RequiredEducation), "p"));
			...
			FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
            list = _fad.FilterDropdown<T_RequiredEducation>(User, list, "T_RequiredEducation", null);
			if (key != null && key.Length > 0)
            {
			   var data = from x in list.Where(p=>p.DisplayValue.Contains(key)).OrderBy(q=>q.DisplayValue).Take(10).ToList()
                           select new { Id = x.Id, Name = x.DisplayValue };
        ...
        public ActionResult Upload()
        {
			...
			if (!((CustomPrincipal)User).CanUseVerb("ImportExcel", "T_RequiredEducation", User) || !User.CanAdd("T_RequiredEducation"))
            {
                return RedirectToAction("Index", "Error");
            }
            //ViewBag.IsMapping = (db.ImportConfigurations.Where(p => p.Name == "T_RequiredEducation")).Count() > 0 ? true : false;
            var lstMappings = db.ImportConfigurations.Where(p => p.Name == "T_RequiredEducation").ToList();
         ...
         public ActionResult Upload([Bind(Include = "FileUpload")] HttpPostedFileBase FileUpload, FormCollection collection)
        {
            if (FileUpload != null)
            {
                ...
                if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv" || fileExtension == ".all")
                {
                    ...
                    var entList = GeneratorBase.MVC.ModelReflector.Entities.FirstOrDefault(e => e.Name == "T_RequiredEducation");
                    if (entList != null)
                    {
					...
					if (!string.IsNullOrEmpty(collection["ListOfMappings"]))
                    {
                        ...
                        {
                            var lstMapping = db.ImportConfigurations.Where(p => p.Name == "T_RequiredEducation" && p.IsDefaultMapping);
                        ...
                        DetailMessage = "We have received " + objDataSet.Tables[0].Rows.Count + " new Required Educations";
                        ...
                        if (entList != null)
                        {
                            ...
                            foreach (var association in entList.Associations)
                            {
                                ...
                                for (int i = 0; i < uniqueCols.Rows.Count; i++)
                                {
                                    ...
                                    {
                                										 case "T_RoleCodeRequiredEducationID":
										 var t_rolecoderequirededucationId = db.T_RoleCodes.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_rolecoderequirededucationId == null)
											uniqueassoValues.Add(assovalue);
										 break;
																		 case "T_RequiredEducationSOCCodeID":
										 var t_requirededucationsoccodeId = db.T_SocCodes.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_requirededucationsoccodeId == null)
											uniqueassoValues.Add(assovalue);
										 break;
																		 case "T_RequiredEducationEducationLevelID":
										 var t_requirededucationeducationlevelId = db.T_EducationLevels.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_requirededucationeducationlevelId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                        default:
                                            break;
        ...
        public ActionResult ConfirmImportData(FormCollection collection)
        {
            ...
            string excelConnectionString = string.Empty;
			string typename = "T_RequiredEducation";
                ...
                if (entList != null)
                {
                    ...
                    foreach (var association in entList.Associations)
                    {
                        ...
                        for (int i = 0; i < uniqueCols.Rows.Count; i++)
                        {
                            ...
                            {
                                										 case "T_RoleCodeRequiredEducationID":
										 var strPropertyT_RoleCodeRequiredEducation = lstEntityProp.FirstOrDefault(p => p.Key == "T_RoleCodeRequiredEducationID").Value;
										 ModelReflector.Property propT_RoleCodeRequiredEducation = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_RoleCode").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_RoleCodeRequiredEducation);
										 //var elementTypeT_RoleCodeRequiredEducation = db.T_RoleCodes.ElementType;
										 //var propertyInfoT_RoleCodeRequiredEducation = elementTypeT_RoleCodeRequiredEducation.GetProperty(propT_RoleCodeRequiredEducation.Name);
										 // var t_rolecoderequirededucationId = db.T_RoleCodes.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_RoleCodeRequiredEducation.GetValue(p, null)) == assovalue);
										 var t_rolecoderequirededucationId = db.T_RoleCodes.Where(propT_RoleCodeRequiredEducation.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_rolecoderequirededucationId == null)
											uniqueassoValues.Add(assovalue);
										 break;
																		 case "T_RequiredEducationSOCCodeID":
										 var strPropertyT_RequiredEducationSOCCode = lstEntityProp.FirstOrDefault(p => p.Key == "T_RequiredEducationSOCCodeID").Value;
										 ModelReflector.Property propT_RequiredEducationSOCCode = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_SocCode").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_RequiredEducationSOCCode);
										 //var elementTypeT_RequiredEducationSOCCode = db.T_SocCodes.ElementType;
										 //var propertyInfoT_RequiredEducationSOCCode = elementTypeT_RequiredEducationSOCCode.GetProperty(propT_RequiredEducationSOCCode.Name);
										 // var t_requirededucationsoccodeId = db.T_SocCodes.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_RequiredEducationSOCCode.GetValue(p, null)) == assovalue);
										 var t_requirededucationsoccodeId = db.T_SocCodes.Where(propT_RequiredEducationSOCCode.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_requirededucationsoccodeId == null)
											uniqueassoValues.Add(assovalue);
										 break;
																		 case "T_RequiredEducationEducationLevelID":
										 var strPropertyT_RequiredEducationEducationLevel = lstEntityProp.FirstOrDefault(p => p.Key == "T_RequiredEducationEducationLevelID").Value;
										 ModelReflector.Property propT_RequiredEducationEducationLevel = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_EducationLevel").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_RequiredEducationEducationLevel);
										 //var elementTypeT_RequiredEducationEducationLevel = db.T_EducationLevels.ElementType;
										 //var propertyInfoT_RequiredEducationEducationLevel = elementTypeT_RequiredEducationEducationLevel.GetProperty(propT_RequiredEducationEducationLevel.Name);
										 // var t_requirededucationeducationlevelId = db.T_EducationLevels.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_RequiredEducationEducationLevel.GetValue(p, null)) == assovalue);
										 var t_requirededucationeducationlevelId = db.T_EducationLevels.Where(propT_RequiredEducationEducationLevel.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_requirededucationeducationlevelId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                default:
            ...
            if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv")
            {
                ...
                if (selectedlist != null && columnlist != null)
                {
                    for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (AreAllColumnsEmpty(objDataSet.Tables[0].Rows[i], sheetColumns))
                            continue;
                        T_RequiredEducation model = new T_RequiredEducation();
	...
	break;
					 case "T_RoleCodeRequiredEducationID":
		 dynamic t_rolecoderequirededucationId = null;
		 if(lstEntityProp.Count > 0)
		 {
			 ...
			 //var elementTypeT_RoleCodeRequiredEducation = db.T_RoleCodes.ElementType;
			 //var propertyInfoT_RoleCodeRequiredEducation = elementTypeT_RoleCodeRequiredEducation.GetProperty(propT_RoleCodeRequiredEducation.Name);			 
			 //t_rolecoderequirededucationId = db.T_RoleCodes.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_RoleCodeRequiredEducation.GetValue(p, null)) == columnValue);
			 t_rolecoderequirededucationId = db.T_RoleCodes.Where(propT_RoleCodeRequiredEducation.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_rolecoderequirededucationId = db.T_RoleCodes.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_rolecoderequirededucationId != null)
			model.T_RoleCodeRequiredEducationID = t_rolecoderequirededucationId.Id;
		  else
			{
				if ((collection["T_RoleCodeRequiredEducationID"].ToString() == "true,false"))
				{
					try
					{
				 ...
				 try { objT_RoleCode.T_Title =(columnValue); }
						...
						db.SaveChanges();
						model.T_RoleCodeRequiredEducationID = objT_RoleCode.Id;
					}
					catch
					{
						continue;
         ...
         break;
		 case "T_RequiredEducationSOCCodeID":
		 dynamic t_requirededucationsoccodeId = null;
		 if(lstEntityProp.Count > 0)
		 {
			 var strPropertyT_RequiredEducationSOCCode = lstEntityProp.FirstOrDefault(p => p.Key == "T_RequiredEducationSOCCodeID").Value;
			 ModelReflector.Property propT_RequiredEducationSOCCode = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_SocCode").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_RequiredEducationSOCCode);
			 //var elementTypeT_RequiredEducationSOCCode = db.T_SocCodes.ElementType;
			 //var propertyInfoT_RequiredEducationSOCCode = elementTypeT_RequiredEducationSOCCode.GetProperty(propT_RequiredEducationSOCCode.Name);			 
			 //t_requirededucationsoccodeId = db.T_SocCodes.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_RequiredEducationSOCCode.GetValue(p, null)) == columnValue);
			 t_requirededucationsoccodeId = db.T_SocCodes.Where(propT_RequiredEducationSOCCode.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_requirededucationsoccodeId = db.T_SocCodes.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_requirededucationsoccodeId != null)
			model.T_RequiredEducationSOCCodeID = t_requirededucationsoccodeId.Id;
		  else
			{
				if ((collection["T_RequiredEducationSOCCodeID"].ToString() == "true,false"))
				{
					try
					{
						...
						db.SaveChanges();
						model.T_RequiredEducationSOCCodeID = objT_SocCode.Id;
					}
					catch
					{
						continue;
         ...
         break;
		 case "T_RequiredEducationEducationLevelID":
		 dynamic t_requirededucationeducationlevelId = null;
		 if(lstEntityProp.Count > 0)
		 {
			 var strPropertyT_RequiredEducationEducationLevel = lstEntityProp.FirstOrDefault(p => p.Key == "T_RequiredEducationEducationLevelID").Value;
			 ModelReflector.Property propT_RequiredEducationEducationLevel = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_EducationLevel").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_RequiredEducationEducationLevel);
			 //var elementTypeT_RequiredEducationEducationLevel = db.T_EducationLevels.ElementType;
			 //var propertyInfoT_RequiredEducationEducationLevel = elementTypeT_RequiredEducationEducationLevel.GetProperty(propT_RequiredEducationEducationLevel.Name);			 
			 //t_requirededucationeducationlevelId = db.T_EducationLevels.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_RequiredEducationEducationLevel.GetValue(p, null)) == columnValue);
			 t_requirededucationeducationlevelId = db.T_EducationLevels.Where(propT_RequiredEducationEducationLevel.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_requirededucationeducationlevelId = db.T_EducationLevels.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_requirededucationeducationlevelId != null)
			model.T_RequiredEducationEducationLevelID = t_requirededucationeducationlevelId.Id;
		  else
			{
				if ((collection["T_RequiredEducationEducationLevelID"].ToString() == "true,false"))
				{
					try
					{
						...
						db.SaveChanges();
						model.T_RequiredEducationEducationLevelID = objT_EducationLevel.Id;
					}
					catch
					{
						continue;
                ...
                break;
					    ...
					    if (ValidateModel(model))
                        {
                            ...
                            if (result == null || result.Count == 0)
                            {
								...
								{
									db.T_RequiredEducations.Add(model);
									db.SaveChanges();
								}
								error += customerror;
							}
		...
		public bool ValidateModel(T_RequiredEducation validate)
        {
		...
		public object GetFieldValueByEntityId(long Id, string PropName)
        {
            ...
            {
			                ApplicationContext db1 = new ApplicationContext(new SystemUser());
                var obj1 = db1.T_RequiredEducations.Find(Id);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetReadOnlyProperties(T_RequiredEducation OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            if (User.businessrules != null)
            {
                var BR = User.businessrules.Where(p => p.EntityName == "T_RequiredEducation").ToList();
                var BRAll = BR;
                if (BR != null && BR.Count > 0)
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.ReadOnlyPropertiesRule(OModel, BR, "T_RequiredEducation");
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetMandatoryProperties(T_RequiredEducation OModel, string ruleType)
        {
            ...
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
					...
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.MandatoryPropertiesRule(OModel, BR, "T_RequiredEducation");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetUIAlertBusinessRules(T_RequiredEducation OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.UIAlertRule(OModel, BR, "T_RequiredEducation");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetValidateBeforeSaveProperties(T_RequiredEducation OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.ValidateBeforeSavePropertiesRule(OModel, BR, "T_RequiredEducation",state);
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetLockBusinessRules(T_RequiredEducation OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            //string RulesApplied = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.LockEntityRule(OModel, BR, "T_RequiredEducation");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		private List<string> CheckMandatoryProperties(T_RequiredEducation OModel)
        {
                ...
                if (BR != null && BR.Count > 0)
                {
                    ...
                    if (ResultOfBusinessRules.Keys.Select(p=>p.TypeNo).Contains(2))
                    {
                        ...
                        foreach (string paramName in Args.Select(p => p.ParameterName))
                        {
                            ...
                            {
                                var dispName = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_RequiredEducation").Properties.FirstOrDefault(p => p.Name == paramName).DisplayName;
                                result.Add(dispName);
                            }
                        }
                    }
		...
		public long? GetIdFromDisplayValue(string displayvalue)
        {
            ...
            var _Obj = db1.T_RequiredEducations.FirstOrDefault(p => p.DisplayValue == displayvalue);
            long outValue;
            if (_Obj != null)
        ...
        {
            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            IQueryable query = db1.T_RequiredEducations;
            Type[] exprArgTypes = { query.ElementType };
            ...
            lambda = Expression.Lambda<Func<T_RequiredEducation, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(PropValue), member.Type)), p);
            else
                lambda = Expression.Lambda<Func<T_RequiredEducation, bool>>(Expression.Equal(member, Expression.Constant(null, member.Type)), p);
            MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
            IQueryable q = query.Provider.CreateQuery(methodCall);
            long outValue;
            var list1 = ((IQueryable<T_RequiredEducation>)q);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult Check1MThresholdValue(T_RequiredEducation t_requirededucation)
        {
        ...
        public ActionResult GetCalculationValues(T_RequiredEducation t_requirededucation)
        {
            t_requirededucation.setCalculation();
            Dictionary<string, string> Calculations = new Dictionary<string, string>();
            System.Reflection.PropertyInfo[] properties = (t_requirededucation.GetType()).GetProperties().Where(p => p.PropertyType.FullName.StartsWith("System")).ToArray();
        ...
        public void GetTemplatesForList(string defaultview)
        {
            ...
            var lstDefaultEntityPage = from s in db.DefaultEntityPages
                                       where s.EntityName == "T_RequiredEducation"
                                       select s;
	...
	[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetails(T_RequiredEducation t_requirededucation, string IgnoreEditable)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetailsInline(string host, string value, T_RequiredEducation t_requirededucation, string IgnoreEditable)
        {
            Dictionary<string, string> derivedlist = new Dictionary<string, string>();
            return Json(derivedlist, "application/json", System.Text.Encoding.UTF8, JsonRequestBehavior.AllowGet);
        }
