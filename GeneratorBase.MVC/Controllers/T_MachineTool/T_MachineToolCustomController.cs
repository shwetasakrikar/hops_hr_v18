...
{	
    ...
    {
		public bool CheckBeforeDelete(T_MachineTool t_machinetool)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_MachineTool t_machinetool, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_MachineTool t_machinetool)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_MachineTool t_machinetool, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_MachineTool t_machinetool)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_MachineTool t_machinetool)
{
}
private void CustomLoadViewDataListBeforeEdit(T_MachineTool t_machinetool)
{
}
private void CustomLoadViewDataListAfterEdit(T_MachineTool t_machinetool)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_MachineTool t_machinetool, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_MachineTool t_machinetool, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_MachineTool t_machinetool, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_MachineTool t_machinetool, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_MachineTool> CustomSorting(IQueryable<T_MachineTool> list)
{
    IQueryable<T_MachineTool> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_MachineTool t_machinetool,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_MachineTool");
    return null;
}
	}
}
