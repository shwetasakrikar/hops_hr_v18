...
{	
    ...
    {
		public bool CheckBeforeDelete(T_LeaveProfileReason t_leaveprofilereason)
        {
            var result = true;
		...
		public void OnDeleting(T_LeaveProfileReason t_leaveprofilereason)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_LeaveProfileReason t_leaveprofilereason, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_LeaveProfileReason t_leaveprofilereason)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_LeaveProfileReason t_leaveprofilereason)
{
}
private void CustomLoadViewDataListBeforeEdit(T_LeaveProfileReason t_leaveprofilereason)
{
}
...
private bool CustomSaveOnCreate(T_LeaveProfileReason t_leaveprofilereason, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_LeaveProfileReason t_leaveprofilereason, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_LeaveProfileReason t_leaveprofilereason, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_LeaveProfileReason t_leaveprofilereason, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_LeaveProfileReason> CustomSorting(IQueryable<T_LeaveProfileReason> list)
{
    IQueryable<T_LeaveProfileReason> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_LeaveProfileReason t_leaveprofilereason,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_LeaveProfileReason");
    return null;
}
	}
}
