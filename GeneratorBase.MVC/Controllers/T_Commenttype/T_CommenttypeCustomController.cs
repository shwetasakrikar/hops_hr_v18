...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Commenttype t_commenttype)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Commenttype t_commenttype, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Commenttype t_commenttype)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Commenttype t_commenttype, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Commenttype t_commenttype)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Commenttype t_commenttype)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Commenttype t_commenttype)
{
}
private void CustomLoadViewDataListAfterEdit(T_Commenttype t_commenttype)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Commenttype t_commenttype, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Commenttype t_commenttype, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Commenttype t_commenttype, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Commenttype t_commenttype, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Commenttype> CustomSorting(IQueryable<T_Commenttype> list)
{
    IQueryable<T_Commenttype> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Commenttype t_commenttype,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Commenttype");
    return null;
}
	}
}
