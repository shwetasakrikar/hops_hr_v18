...
{	
    ...
    {
		private void LoadViewDataForCount(T_AllFacilitiesUnit t_allfacilitiesunit, string AssocType)
        {
        }
		private void LoadViewDataAfterOnEdit(T_AllFacilitiesUnit t_allfacilitiesunit)
        {		
			 ViewBag.T_UnitsforAllFaciltiesID = new SelectList(db.T_AllFacilitiess, "ID", "DisplayValue", t_allfacilitiesunit.T_UnitsforAllFaciltiesID);
			CustomLoadViewDataListAfterEdit(t_allfacilitiesunit);
        }
        private void LoadViewDataBeforeOnEdit(T_AllFacilitiesUnit t_allfacilitiesunit)
        {		
               var _objT_UnitsforAllFacilties = new List<T_AllFacilities>();
               _objT_UnitsforAllFacilties.Add(t_allfacilitiesunit.t_unitsforallfacilties);
			   			   ViewBag.T_UnitsforAllFaciltiesID = new SelectList(_objT_UnitsforAllFacilties, "ID", "DisplayValue", t_allfacilitiesunit.T_UnitsforAllFaciltiesID);
				 ViewBag.T_UnitWhereAccidentOccuredCount = t_allfacilitiesunit.t_unitwhereaccidentoccured.Count();
	 ViewBag.T_AllUnitsFloorCount = t_allfacilitiesunit.t_allunitsfloor.Count();
		CustomLoadViewDataListBeforeEdit(t_allfacilitiesunit);
        }
        private void LoadViewDataAfterOnCreate(T_AllFacilitiesUnit t_allfacilitiesunit)
        {			
			 ViewBag.T_UnitsforAllFaciltiesID = new SelectList(db.T_AllFacilitiess, "ID", "DisplayValue", t_allfacilitiesunit.T_UnitsforAllFaciltiesID);
		CustomLoadViewDataListAfterOnCreate(t_allfacilitiesunit);
        }
        private void LoadViewDataBeforeOnCreate(string HostingEntityName, string HostingEntityID, string AssociatedType)
        {			
			if(HostingEntityName == "T_AllFacilities" && Convert.ToInt64(HostingEntityID) > 0 && AssociatedType=="T_UnitsforAllFacilties")
			{
			    var hostid = Convert.ToInt64(HostingEntityID);
				ViewBag.T_UnitsforAllFaciltiesID = new SelectList(db.T_AllFacilitiess.Where(p=>p.Id==hostid).ToList(), "ID", "DisplayValue",HostingEntityID);
				ViewBag.DisplayVal = db.T_AllFacilitiess.Where(p => p.Id == hostid).ToList().FirstOrDefault().DisplayValue;
		    }
            else
			{
			var objT_UnitsforAllFacilties = new List<T_AllFacilities>();
			 ViewBag.T_UnitsforAllFaciltiesID = new SelectList(objT_UnitsforAllFacilties , "ID", "DisplayValue");
		    }
			CustomLoadViewDataListBeforeOnCreate(HostingEntityName, HostingEntityID, AssociatedType);
        }
		private IQueryable<T_AllFacilitiesUnit> searchRecords(IQueryable<T_AllFacilitiesUnit> lstT_AllFacilitiesUnit, string searchString, bool? IsDeepSearch)
        {
		   searchString = searchString.Trim();
		if(Convert.ToBoolean(IsDeepSearch))
            lstT_AllFacilitiesUnit = lstT_AllFacilitiesUnit.Where(s => (!String.IsNullOrEmpty(s.T_Name) && s.T_Name.ToUpper().Contains(searchString)) ||(!String.IsNullOrEmpty(s.T_Description) && s.T_Description.ToUpper().Contains(searchString)) ||(s.t_unitsforallfacilties!= null && (s.t_unitsforallfacilties.DisplayValue.ToUpper().Contains(searchString) )) ||(!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
		else
			 lstT_AllFacilitiesUnit = lstT_AllFacilitiesUnit.Where(s => (!String.IsNullOrEmpty(s.T_Name) && s.T_Name.ToUpper().Contains(searchString)) ||(!String.IsNullOrEmpty(s.T_Description) && s.T_Description.ToUpper().Contains(searchString)) ||(s.t_unitsforallfacilties!= null && (s.t_unitsforallfacilties.DisplayValue.ToUpper().Contains(searchString) )) ||(!String.IsNullOrEmpty(s.DisplayValue) && s.DisplayValue.ToUpper().Contains(searchString)));
            return lstT_AllFacilitiesUnit;
        }
		private IQueryable<T_AllFacilitiesUnit> sortRecords(IQueryable<T_AllFacilitiesUnit> lstT_AllFacilitiesUnit, string sortBy, string isAsc)
        {
            string methodName = "";
	 ...
	 if(sortBy == "T_UnitsforAllFaciltiesID")
                return isAsc.ToLower() == "asc" ? lstT_AllFacilitiesUnit.OrderBy(p => p.t_unitsforallfacilties.DisplayValue) : lstT_AllFacilitiesUnit.OrderByDescending(p => p.t_unitsforallfacilties.DisplayValue);
		    if (sortBy.Contains("."))
                return isAsc.ToLower() == "asc" ? lstT_AllFacilitiesUnit.Sort(sortBy,true) : lstT_AllFacilitiesUnit.Sort(sortBy,false);
            ParameterExpression paramExpression = Expression.Parameter(typeof(T_AllFacilitiesUnit), "t_allfacilitiesunit");
            MemberExpression memExp = Expression.PropertyOrField(paramExpression, sortBy);
            LambdaExpression lambda = Expression.Lambda(memExp, paramExpression);
            return (IQueryable<T_AllFacilitiesUnit>)lstT_AllFacilitiesUnit.Provider.CreateQuery(
                Expression.Call(
                    typeof(Queryable),
                    methodName,
                    new Type[] { lstT_AllFacilitiesUnit.ElementType, lambda.Body.Type },
                    lstT_AllFacilitiesUnit.Expression,
                    lambda));
        }
		public ActionResult FindFSearch(string id, string sourceEntity)
        {
            if (sourceEntity == "T_ServiceRecord")
            {
                ...
                url += "?search=";
						var T_UnitsforAllFacilties  = _Object.T_EmploymentRecordHiredAtFacilityID;
						url += "&t_unitsforallfacilties=" + T_UnitsforAllFacilties;									
            ...
            if (sourceEntity == "T_EmployeeInjury")
            {
                ...
                url += "?search=";
						var T_UnitsforAllFacilties  = _Object.T_FacilityAccidentOccuredID;
						url += "&t_unitsforallfacilties=" + T_UnitsforAllFacilties;									
                Response.Redirect(url.ToString());
            }
            return null;
        }
        public ActionResult SetFSearch(string searchString, string HostingEntity ,string t_unitsforallfacilties, bool? RenderPartial)
        {
			int Qcount = 0;
			...
			if(Qcount > 0)
			{
			var T_UnitsforAllFaciltieslist = db.T_AllFacilitiess.OrderBy(p=>p.DisplayValue).Take(10).Distinct();
            if (t_unitsforallfacilties != null)
            {
                var ids = t_unitsforallfacilties.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
				 ViewBag.SearchResult += "\r\n Facility= ";
				   foreach (var str in ids)
					...
					ids1 = ids1.ToList();
					var list = T_UnitsforAllFaciltieslist.Union(db.T_AllFacilitiess.Where(p=>ids1.Contains(p.Id))).Distinct();
					FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
					list = _fad.FilterDropdown<T_AllFacilities>(User, list, "T_AllFacilities", null);
					ViewBag.t_unitsforallfacilties = new SelectList(list, "ID", "DisplayValue");
			}
			else
			{
				var list = T_UnitsforAllFaciltieslist;
				FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
				list = _fad.FilterDropdown<T_AllFacilities>(User, list, "T_AllFacilities", null);
				ViewBag.t_unitsforallfacilties = new SelectList(list, "ID", "DisplayValue");
			}
			...
			{
			var objT_UnitsforAllFacilties = new List<T_AllFacilities>();
		    ViewBag.t_unitsforallfacilties = new SelectList(objT_UnitsforAllFacilties, "ID", "DisplayValue");
			}
				...
				ViewBag.EntityName = "T_AllFacilitiesUnit";
                ...
                case "DateTime":
                    {
					   ...
					   {
							expression = string.Format(" DbFunctions.TruncateTime(" + property + ") " + operators + " (\"{0}\")", (TimeZoneInfo.ConvertTimeFromUtc(DateTime.UtcNow, (new T_AllFacilitiesUnit()).m_Timezone)).Date);
						}
						else
						{
		...
		// GET: /T_AllFacilitiesUnit/FSearch/
		public ActionResult FSearch(string currentFilter, string searchString, string FSFilter, string sortBy, string isAsc, int? page, int? itemsPerPage, string search, bool? IsExport ,string t_unitsforallfacilties ,string FilterCondition, string HostingEntity, string AssociatedType,string HostingEntityID, string viewtype, string SortOrder, string HideColumns, string GroupByColumn,bool? IsReports, bool? IsdrivedTab)
        {
            ...
            {
                lstT_AllFacilitiesUnit  = searchRecords(lstT_AllFacilitiesUnit, searchString.ToUpper(),true);
            }
			  if(!string.IsNullOrEmpty(search))
                	search=search.Replace("?IsAddPop=true", "");
			if(!string.IsNullOrEmpty(search)){
				ViewBag.SearchResult += "\r\n General Criterial= "+search;
				lstT_AllFacilitiesUnit = searchRecords(lstT_AllFacilitiesUnit, search,true);
			}
			...
			lstT_AllFacilitiesUnit = lstT_AllFacilitiesUnit.Include(t=>t.t_unitsforallfacilties);
			if (!string.IsNullOrEmpty(FilterCondition))
            {
                ...
                foreach (var cond in conditions)
                {
                    ...
                    if (iCnt == conditions.Count())
                        LogicalConnector = "";
					ViewBag.SearchResult += " " + GetPropertyDP("T_AllFacilitiesUnit", PropertyName) + " " + Operator + " " + Value + " " + LogicalConnector;
                    whereCondition.Append(conditionFSearch(PropertyName, Operator, Value) + LogicalConnector);
                    iCnt++;
                }
                if (!string.IsNullOrEmpty(whereCondition.ToString()))
                    lstT_AllFacilitiesUnit = lstT_AllFacilitiesUnit.Where(whereCondition.ToString());
            ...
            if (!string.IsNullOrEmpty(DataOrdering))
                lstT_AllFacilitiesUnit = Sorting.Sort<T_AllFacilitiesUnit>(lstT_AllFacilitiesUnit, DataOrdering);
            var _T_AllFacilitiesUnit = lstT_AllFacilitiesUnit;
			//if (lstT_AllFacilitiesUnit.Where(p => p.t_unitsforallfacilties != null).Count() <= 50)
		    //ViewBag.t_unitsforallfacilties = new SelectList(lstT_AllFacilitiesUnit.Where(p => p.t_unitsforallfacilties != null).Select(P => P.t_unitsforallfacilties).Distinct(), "ID", "DisplayValue");
            if (t_unitsforallfacilties != null)
            {
                var ids = t_unitsforallfacilties.Split(",".ToCharArray());
                List<long?> ids1 = new List<long?>();
                ...
                ids1 = ids1.ToList();
                _T_AllFacilitiesUnit = _T_AllFacilitiesUnit.Where(p => ids1.Contains(p.T_UnitsforAllFaciltiesID));
            }
				if (!string.IsNullOrEmpty(SortOrder))
            {
                ViewBag.SearchResult += " \r\n Sort Order = ";
                ...
                var Entity = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_AllFacilitiesUnit");
			...
			if (!Request.IsAjaxRequest())
			{
				...
				if (!string.IsNullOrEmpty(GroupByColumn))
                    foreach (var item in list)
                    {
                        ...
                        item.m_DisplayValue = EntityComparer.GetGroupByDisplayValue(item, "T_AllFacilitiesUnit", tagsSplit.ToArray());
                    }
        ...
        {
		string result = "";
		var entity = "T_AllFacilitiesUnit";
           ...
           var entitylist = db.T_AllFacilitiesUnits;
		...
		public string ShowGraph1(string type, int? inlarge)
        {
            string result = "";
           {
                var gd = db.T_AllFacilitiesUnits.GroupBy(p => p.t_unitsforallfacilties.DisplayValue).ToList();
			   ...
			   var chart = new System.Web.UI.DataVisualization.Charting.Chart
                ...
                chart.ChartAreas.Add(CreateChartArea(SeriesChartType.Column, "", "Facility", "All Facilities Unit"));
                ...
                if (cntgrt10)
                    {
                        string img = "<div class='col-sm-4' style='padding:0px; margin:0px 0px 0px 0px;'><img src='data:image/png;base64,{0}' alt='' usemap='#ImageMap' style='width:100%; cursor: pointer;' " + (inlarge == null ? "data-toggle='modal' data-target='#dvPopupBulkOperation' onclick=\"OpenPopUpGraph('PopupBulkOperation','dvPopupBulkOperation','" + Url.Action("ShowGraph", "T_AllFacilitiesUnit", new { type = "1", inlarge = 1 }) + "')\"" : "") + "/></div>";
                        string encoded = Convert.ToBase64String(bytes.ToArray());
                        result += String.Format(img, encoded);
                    }
                    else
        ...
        public string GetDisplayValue(string id)
        {
            ...
            var _Obj = db1.T_AllFacilitiesUnits.FirstOrDefault(p => p.Id == idvalue);
		...
		public object GetRecordById(string id)
        {
		            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            if (string.IsNullOrEmpty(id)) return "";
            var _Obj = db1.T_AllFacilitiesUnits.Find(Convert.ToInt64(id));
            return _Obj;
        }
		public string GetRecordById_Reflection(string id)
        {
			...
			if (string.IsNullOrEmpty(id)) return "";
			var _Obj = db1.T_AllFacilitiesUnits.Find(Convert.ToInt64(id));
            return _Obj == null ? "" : EntityComparer.EnumeratePropertyValues<T_AllFacilitiesUnit>(_Obj, "T_AllFacilitiesUnit", new string[] { ""  }); ;
			        }
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetAllValueForFilter(string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
		            IQueryable<T_AllFacilitiesUnit> list = db.T_AllFacilitiesUnits;
		...
		public JsonResult GetAllValue(string caller, string key, string AssoNameWithParent, string AssociationID, string ExtraVal)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                {
                    IQueryable query = db.T_AllFacilitiesUnits;
					string lambda = "";
                   ...
                   // ParameterExpression p = Expression.Parameter(typeof(T_AllFacilitiesUnit), "p");
                   // MemberExpression member = Expression.PropertyOrField(p, propToWhere);
                   // LambdaExpression lambda = Expression.Lambda<Func<T_AllFacilitiesUnit, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(AssoID), member.Type)), p);
                   // MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
                   // IQueryable q = query.Provider.CreateQuery(methodCall);
                   //list = ((IQueryable<T_AllFacilitiesUnit>)q);
				   list = ((IQueryable<T_AllFacilitiesUnit>)query);
                }
				else if (AssoID == 0)
                {
                   IQueryable query = db.T_AllFacilitiesUnits;
			...
			FilterApplicationDropdowns _fad = new FilterApplicationDropdowns();
            list = _fad.FilterDropdown<T_AllFacilitiesUnit>(User,list, "T_AllFacilitiesUnit",caller);
...
[AcceptVerbs(HttpVerbs.Get)]
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
				try
                {
					...
					if (AssoID != null && AssoID > 0)
					{
						...
						MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
						IQueryable q = query.Provider.CreateQuery(methodCall);
						list = ((IQueryable<T_AllFacilitiesUnit>)q).Take(20);
					}
				}
				catch
                {
        ...
        public JsonResult GetAllMultiSelectValueForBR(string propNameBR)
        {
            ...
            if (!string.IsNullOrEmpty(propNameBR))
            {
				...
				//
                ParameterExpression param = Expression.Parameter(typeof(T_AllFacilitiesUnit), "d");
                //bulid expression tree:data.Field1
                var Property = typeof(T_AllFacilitiesUnit).GetProperty(propNameBR);
                ...
                if (targetType.GetGenericArguments().Count() > 0)
                {
                    if (targetType.GetGenericArguments()[0].Name == "DateTime")
                    {
                        ...
                        new Type[] { typeof(T_AllFacilitiesUnit), typeof(DateTime?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                if (targetType.IsGenericType && targetType.GetGenericTypeDefinition() == typeof(Nullable<>))
                {
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_AllFacilitiesUnit), typeof(decimal?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_AllFacilitiesUnit), typeof(bool?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_AllFacilitiesUnit), typeof(Int32?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_AllFacilitiesUnit), typeof(Int64?) }, Expression.Constant(list.AsQueryable()), pred);
                    ...
                    {
                        Expression expr = Expression.Call(typeof(Queryable), "Select",
                        new Type[] { typeof(T_AllFacilitiesUnit), typeof(double?) }, Expression.Constant(list.AsQueryable()), pred);
                ...
                {
                    Expression expr = Expression.Call(typeof(Queryable), "Select",
                            new Type[] { typeof(T_AllFacilitiesUnit), typeof(string) }, Expression.Constant(list.AsQueryable()), pred);
        ...
        public JsonResult GetAllMultiSelectValue(string key, string AssoNameWithParent, string AssociationID)
        {
            ...
            if (AssoNameWithParent != null && !string.IsNullOrEmpty(AssociationID))
            {
                ...
                paramList.Add(Expression.Parameter(typeof(T_AllFacilitiesUnit), "p"));
        ...
        public ActionResult Upload()
        {
			...
			if (!((CustomPrincipal)User).CanUseVerb("ImportExcel", "T_AllFacilitiesUnit", User) || !User.CanAdd("T_AllFacilitiesUnit"))
            {
                return RedirectToAction("Index", "Error");
            }
            //ViewBag.IsMapping = (db.ImportConfigurations.Where(p => p.Name == "T_AllFacilitiesUnit")).Count() > 0 ? true : false;
            var lstMappings = db.ImportConfigurations.Where(p => p.Name == "T_AllFacilitiesUnit").ToList();
         ...
         public ActionResult Upload([Bind(Include = "FileUpload")] HttpPostedFileBase FileUpload, FormCollection collection)
        {
            if (FileUpload != null)
            {
                ...
                if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv" || fileExtension == ".all")
                {
                    ...
                    var entList = GeneratorBase.MVC.ModelReflector.Entities.FirstOrDefault(e => e.Name == "T_AllFacilitiesUnit");
                    if (entList != null)
                    {
					...
					if (!string.IsNullOrEmpty(collection["ListOfMappings"]))
                    {
                        ...
                        {
                            var lstMapping = db.ImportConfigurations.Where(p => p.Name == "T_AllFacilitiesUnit" && p.IsDefaultMapping);
                        ...
                        DetailMessage = "We have received " + objDataSet.Tables[0].Rows.Count + " new All Facilities Units";
                        ...
                        if (entList != null)
                        {
                            ...
                            foreach (var association in entList.Associations)
                            {
                                ...
                                for (int i = 0; i < uniqueCols.Rows.Count; i++)
                                {
                                    ...
                                    {
                                										 case "T_UnitsforAllFaciltiesID":
										 var t_unitsforallfaciltiesId = db.T_AllFacilitiess.FirstOrDefault(p => p.DisplayValue == assovalue);
										 if (t_unitsforallfaciltiesId == null)
        ...
        public ActionResult ConfirmImportData(FormCollection collection)
        {
            ...
            string excelConnectionString = string.Empty;
			string typename = "T_AllFacilitiesUnit";
                ...
                if (entList != null)
                {
                    ...
                    foreach (var association in entList.Associations)
                    {
                        ...
                        for (int i = 0; i < uniqueCols.Rows.Count; i++)
                        {
                            ...
                            {
                                										 case "T_UnitsforAllFaciltiesID":
										 var strPropertyT_UnitsforAllFacilties = lstEntityProp.FirstOrDefault(p => p.Key == "T_UnitsforAllFaciltiesID").Value;
										 ModelReflector.Property propT_UnitsforAllFacilties = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_AllFacilities").Properties.FirstOrDefault(p => p.DisplayName == strPropertyT_UnitsforAllFacilties);
										 //var elementTypeT_UnitsforAllFacilties = db.T_AllFacilitiess.ElementType;
										 //var propertyInfoT_UnitsforAllFacilties = elementTypeT_UnitsforAllFacilties.GetProperty(propT_UnitsforAllFacilties.Name);
										 // var t_unitsforallfaciltiesId = db.T_AllFacilitiess.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_UnitsforAllFacilties.GetValue(p, null)) == assovalue);
										 var t_unitsforallfaciltiesId = db.T_AllFacilitiess.Where(propT_UnitsforAllFacilties.Name+"=\""+assovalue+"\"").FirstOrDefault();
										 if (t_unitsforallfaciltiesId == null)
											uniqueassoValues.Add(assovalue);
										 break;
								                                default:
            ...
            if (fileExtension == ".xls" || fileExtension == ".xlsx" || fileExtension == ".csv")
            {
                ...
                if (selectedlist != null && columnlist != null)
                {
                    for (int i = 0; i < objDataSet.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (AreAllColumnsEmpty(objDataSet.Tables[0].Rows[i], sheetColumns))
                            continue;
                        T_AllFacilitiesUnit model = new T_AllFacilitiesUnit();
	...
	break;
					 case "T_UnitsforAllFaciltiesID":
		 dynamic t_unitsforallfaciltiesId = null;
		 if(lstEntityProp.Count > 0)
		 {
			 ...
			 //var elementTypeT_UnitsforAllFacilties = db.T_AllFacilitiess.ElementType;
			 //var propertyInfoT_UnitsforAllFacilties = elementTypeT_UnitsforAllFacilties.GetProperty(propT_UnitsforAllFacilties.Name);			 
			 //t_unitsforallfaciltiesId = db.T_AllFacilitiess.AsEnumerable().FirstOrDefault(p => Convert.ToString(propertyInfoT_UnitsforAllFacilties.GetValue(p, null)) == columnValue);
			 t_unitsforallfaciltiesId = db.T_AllFacilitiess.Where(propT_UnitsforAllFacilties.Name + "=\"" + columnValue + "\"").FirstOrDefault();
		 }
		 else
			t_unitsforallfaciltiesId = db.T_AllFacilitiess.FirstOrDefault(p=>p.DisplayValue == columnValue);
		 if (t_unitsforallfaciltiesId != null)
			model.T_UnitsforAllFaciltiesID = t_unitsforallfaciltiesId.Id;
		  else
			{
				if ((collection["T_UnitsforAllFaciltiesID"].ToString() == "true,false"))
				{
					try
					{
						...
						db.SaveChanges();
						model.T_UnitsforAllFaciltiesID = objT_AllFacilities.Id;
					}
					catch
					{
						continue;
                ...
                break;
					    ...
					    if (ValidateModel(model))
                        {
                            ...
                            if (result == null || result.Count == 0)
                            {
								...
								{
									db.T_AllFacilitiesUnits.Add(model);
									db.SaveChanges();
								}
								error += customerror;
							}
		...
		public bool ValidateModel(T_AllFacilitiesUnit validate)
        {
		...
		public object GetFieldValueByEntityId(long Id, string PropName)
        {
            ...
            {
			                ApplicationContext db1 = new ApplicationContext(new SystemUser());
                var obj1 = db1.T_AllFacilitiesUnits.Find(Id);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetReadOnlyProperties(T_AllFacilitiesUnit OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            if (User.businessrules != null)
            {
                var BR = User.businessrules.Where(p => p.EntityName == "T_AllFacilitiesUnit").ToList();
                var BRAll = BR;
                if (BR != null && BR.Count > 0)
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.ReadOnlyPropertiesRule(OModel, BR, "T_AllFacilitiesUnit");
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetMandatoryProperties(T_AllFacilitiesUnit OModel, string ruleType)
        {
            ...
            if (User.businessrules != null)
            {
                ...
                if (BR != null && BR.Count > 0)
                {
					...
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.MandatoryPropertiesRule(OModel, BR, "T_AllFacilitiesUnit");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetUIAlertBusinessRules(T_AllFacilitiesUnit OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.UIAlertRule(OModel, BR, "T_AllFacilitiesUnit");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetValidateBeforeSaveProperties(T_AllFacilitiesUnit OModel, string ruleType)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            var conditions = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.ValidateBeforeSavePropertiesRule(OModel, BR, "T_AllFacilitiesUnit",state);
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
        ...
        [AcceptVerbs(HttpVerbs.Get)]
        public JsonResult GetLockBusinessRules(T_AllFacilitiesUnit OModel)
        {
            Dictionary<string, string> RulesApplied = new Dictionary<string, string>();
            //string RulesApplied = "";
            if (User.businessrules != null)
            {
                ...
                {
					OModel.setCalculation();
                    var ResultOfBusinessRules = db.LockEntityRule(OModel, BR, "T_AllFacilitiesUnit");
                    BR = BR.Where(p => ResultOfBusinessRules.Values.Select(x => x.BRID).ToList().Contains(p.Id)).ToList();
		...
		private List<string> CheckMandatoryProperties(T_AllFacilitiesUnit OModel)
        {
                ...
                if (BR != null && BR.Count > 0)
                {
                    ...
                    if (ResultOfBusinessRules.Keys.Select(p=>p.TypeNo).Contains(2))
                    {
                        ...
                        foreach (string paramName in Args.Select(p => p.ParameterName))
                        {
                            ...
                            {
                                var dispName = ModelReflector.Entities.FirstOrDefault(p => p.Name == "T_AllFacilitiesUnit").Properties.FirstOrDefault(p => p.Name == paramName).DisplayName;
                                result.Add(dispName);
                            }
                        }
                    }
		...
		public long? GetIdFromDisplayValue(string displayvalue)
        {
            ...
            var _Obj = db1.T_AllFacilitiesUnits.FirstOrDefault(p => p.DisplayValue == displayvalue);
            long outValue;
            if (_Obj != null)
        ...
        {
            ApplicationContext db1 = new ApplicationContext(new SystemUser());
            IQueryable query = db1.T_AllFacilitiesUnits;
            Type[] exprArgTypes = { query.ElementType };
            ...
            lambda = Expression.Lambda<Func<T_AllFacilitiesUnit, bool>>(Expression.Equal(member, Expression.Convert(Expression.Constant(PropValue), member.Type)), p);
            else
                lambda = Expression.Lambda<Func<T_AllFacilitiesUnit, bool>>(Expression.Equal(member, Expression.Constant(null, member.Type)), p);
            MethodCallExpression methodCall = Expression.Call(typeof(Queryable), "Where", exprArgTypes, query.Expression, lambda);
            IQueryable q = query.Provider.CreateQuery(methodCall);
            long outValue;
            var list1 = ((IQueryable<T_AllFacilitiesUnit>)q);
		...
		[AcceptVerbs(HttpVerbs.Get)]
        public JsonResult Check1MThresholdValue(T_AllFacilitiesUnit t_allfacilitiesunit)
        {
        ...
        {
            string[][] groupsarr = new string[][] { new string[] {"48919","T_AllFacilitiesUnit48919"} };
            return groupsarr;
        }
		[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetCalculationValues(T_AllFacilitiesUnit t_allfacilitiesunit)
        {
            t_allfacilitiesunit.setCalculation();
            Dictionary<string, string> Calculations = new Dictionary<string, string>();
            System.Reflection.PropertyInfo[] properties = (t_allfacilitiesunit.GetType()).GetProperties().Where(p => p.PropertyType.FullName.StartsWith("System")).ToArray();
        ...
        public void GetTemplatesForList(string defaultview)
        {
            ...
            var lstDefaultEntityPage = from s in db.DefaultEntityPages
                                       where s.EntityName == "T_AllFacilitiesUnit"
                                       select s;
	...
	[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetails(T_AllFacilitiesUnit t_allfacilitiesunit, string IgnoreEditable)
        {
		...
		[HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult GetDerivedDetailsInline(string host, string value, T_AllFacilitiesUnit t_allfacilitiesunit, string IgnoreEditable)
        {
            Dictionary<string, string> derivedlist = new Dictionary<string, string>();
            return Json(derivedlist, "application/json", System.Text.Encoding.UTF8, JsonRequestBehavior.AllowGet);
        }
