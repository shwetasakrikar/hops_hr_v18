...
private bool CustomSaveOnCreate(T_UnitX t_unitx, out bool customcreate_hasissues, string command="")
{
            var result = false;
...
private IQueryable<T_UnitX> CustomSorting(IQueryable<T_UnitX> list)
{
    IQueryable<T_UnitX> orderedList = list;
