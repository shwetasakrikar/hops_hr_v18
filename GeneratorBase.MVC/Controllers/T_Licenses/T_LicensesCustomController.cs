...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Licenses t_licenses)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Licenses t_licenses, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Licenses t_licenses)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Licenses t_licenses, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Licenses t_licenses)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Licenses t_licenses)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Licenses t_licenses)
{
}
private void CustomLoadViewDataListAfterEdit(T_Licenses t_licenses)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Licenses t_licenses, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Licenses t_licenses, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Licenses t_licenses, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Licenses t_licenses, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Licenses> CustomSorting(IQueryable<T_Licenses> list)
{
    IQueryable<T_Licenses> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Licenses t_licenses,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Licenses");
    return null;
}
	}
}
