...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Patient t_patient)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Patient t_patient, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Patient t_patient)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Patient t_patient, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Patient t_patient)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Patient t_patient)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Patient t_patient)
{
}
private void CustomLoadViewDataListAfterEdit(T_Patient t_patient)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Patient t_patient, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Patient t_patient, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Patient t_patient, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Patient t_patient, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Patient> CustomSorting(IQueryable<T_Patient> list)
{
    IQueryable<T_Patient> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Patient t_patient,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Patient");
    return null;
}
	}
}
