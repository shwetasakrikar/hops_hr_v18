...
{	
    ...
    {
		public bool CheckBeforeDelete(T_PositionLevel t_positionlevel)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_PositionLevel t_positionlevel, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_PositionLevel t_positionlevel)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_PositionLevel t_positionlevel, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_PositionLevel t_positionlevel)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_PositionLevel t_positionlevel)
{
}
private void CustomLoadViewDataListBeforeEdit(T_PositionLevel t_positionlevel)
{
}
private void CustomLoadViewDataListAfterEdit(T_PositionLevel t_positionlevel)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_PositionLevel t_positionlevel, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_PositionLevel t_positionlevel, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_PositionLevel t_positionlevel, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_PositionLevel t_positionlevel, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_PositionLevel> CustomSorting(IQueryable<T_PositionLevel> list)
{
    IQueryable<T_PositionLevel> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_PositionLevel t_positionlevel,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_PositionLevel");
    return null;
}
	}
}
