...
{	
    public partial class T_DepartmentController : BaseController
    {
		...
		public void OnDeleting(T_Department t_department)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Department t_department, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Department t_department)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Department t_department)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Department t_department)
{
}
private void CustomLoadViewDataListAfterEdit(T_Department t_department)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Department t_department, out bool customcreate_hasissues, string command="")
{
            var result = false;
...
private IQueryable<T_Department> CustomSorting(IQueryable<T_Department> list)
{
    IQueryable<T_Department> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Department t_department,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Department");
    return null;
}
	}
}
