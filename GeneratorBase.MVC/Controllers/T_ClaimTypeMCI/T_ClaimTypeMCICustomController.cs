...
{	
    ...
    {
		public bool CheckBeforeDelete(T_ClaimTypeMCI t_claimtypemci)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_ClaimTypeMCI t_claimtypemci, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_ClaimTypeMCI t_claimtypemci)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_ClaimTypeMCI t_claimtypemci, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_ClaimTypeMCI t_claimtypemci)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_ClaimTypeMCI t_claimtypemci)
{
}
private void CustomLoadViewDataListBeforeEdit(T_ClaimTypeMCI t_claimtypemci)
{
}
private void CustomLoadViewDataListAfterEdit(T_ClaimTypeMCI t_claimtypemci)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_ClaimTypeMCI t_claimtypemci, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_ClaimTypeMCI t_claimtypemci, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_ClaimTypeMCI t_claimtypemci, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_ClaimTypeMCI t_claimtypemci, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_ClaimTypeMCI> CustomSorting(IQueryable<T_ClaimTypeMCI> list)
{
    IQueryable<T_ClaimTypeMCI> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_ClaimTypeMCI t_claimtypemci,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_ClaimTypeMCI");
    return null;
}
	}
}
