...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Vendor t_vendor)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Vendor t_vendor, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Vendor t_vendor)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Vendor t_vendor, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Vendor t_vendor)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Vendor t_vendor)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Vendor t_vendor)
{
}
private void CustomLoadViewDataListAfterEdit(T_Vendor t_vendor)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Vendor t_vendor, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Vendor t_vendor, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Vendor t_vendor, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Vendor t_vendor, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Vendor> CustomSorting(IQueryable<T_Vendor> list)
{
    IQueryable<T_Vendor> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Vendor t_vendor,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Vendor");
    return null;
}
	}
}
