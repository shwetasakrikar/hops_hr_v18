...
{	
    ...
    {
		public bool CheckBeforeDelete(T_ServiceRecord t_servicerecord)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_ServiceRecord t_servicerecord, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_ServiceRecord t_servicerecord)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_ServiceRecord t_servicerecord, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_ServiceRecord t_servicerecord)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_ServiceRecord t_servicerecord)
{
}
private void CustomLoadViewDataListBeforeEdit(T_ServiceRecord t_servicerecord)
{
}
private void CustomLoadViewDataListAfterEdit(T_ServiceRecord t_servicerecord)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_ServiceRecord t_servicerecord, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_ServiceRecord t_servicerecord, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_ServiceRecord t_servicerecord, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_ServiceRecord t_servicerecord, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_ServiceRecord> CustomSorting(IQueryable<T_ServiceRecord> list)
{
    IQueryable<T_ServiceRecord> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_ServiceRecord t_servicerecord,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_ServiceRecord");
    return null;
}
	}
}
