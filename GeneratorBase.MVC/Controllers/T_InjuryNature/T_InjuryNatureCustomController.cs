...
{	
    ...
    {
		public bool CheckBeforeDelete(T_InjuryNature t_injurynature)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_InjuryNature t_injurynature, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_InjuryNature t_injurynature)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_InjuryNature t_injurynature, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_InjuryNature t_injurynature)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_InjuryNature t_injurynature)
{
}
private void CustomLoadViewDataListBeforeEdit(T_InjuryNature t_injurynature)
{
}
private void CustomLoadViewDataListAfterEdit(T_InjuryNature t_injurynature)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_InjuryNature t_injurynature, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_InjuryNature t_injurynature, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_InjuryNature t_injurynature, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_InjuryNature t_injurynature, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_InjuryNature> CustomSorting(IQueryable<T_InjuryNature> list)
{
    IQueryable<T_InjuryNature> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_InjuryNature t_injurynature,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_InjuryNature");
    return null;
}
	}
}
