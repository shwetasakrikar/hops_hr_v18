...
{	
    ...
    {
		public bool CheckBeforeDelete(T_EmployeeType t_employeetype)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_EmployeeType t_employeetype, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_EmployeeType t_employeetype)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_EmployeeType t_employeetype, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_EmployeeType t_employeetype)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_EmployeeType t_employeetype)
{
}
private void CustomLoadViewDataListBeforeEdit(T_EmployeeType t_employeetype)
{
}
private void CustomLoadViewDataListAfterEdit(T_EmployeeType t_employeetype)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_EmployeeType t_employeetype, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_EmployeeType t_employeetype, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_EmployeeType t_employeetype, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_EmployeeType t_employeetype, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_EmployeeType> CustomSorting(IQueryable<T_EmployeeType> list)
{
    IQueryable<T_EmployeeType> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_EmployeeType t_employeetype,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_EmployeeType");
    return null;
}
	}
}
