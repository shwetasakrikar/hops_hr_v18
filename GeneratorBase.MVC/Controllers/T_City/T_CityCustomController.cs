...
{	
    ...
    {
		public bool CheckBeforeDelete(T_City t_city)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_City t_city, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_City t_city)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_City t_city, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_City t_city)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_City t_city)
{
}
private void CustomLoadViewDataListBeforeEdit(T_City t_city)
{
}
private void CustomLoadViewDataListAfterEdit(T_City t_city)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_City t_city, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_City t_city, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_City t_city, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_City t_city, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_City> CustomSorting(IQueryable<T_City> list)
{
    IQueryable<T_City> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_City t_city,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_City");
    return null;
}
	}
}
