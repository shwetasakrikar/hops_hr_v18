...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Refusal t_refusal)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Refusal t_refusal, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Refusal t_refusal)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Refusal t_refusal, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Refusal t_refusal)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Refusal t_refusal)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Refusal t_refusal)
{
}
private void CustomLoadViewDataListAfterEdit(T_Refusal t_refusal)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Refusal t_refusal, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Refusal t_refusal, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Refusal t_refusal, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Refusal t_refusal, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Refusal> CustomSorting(IQueryable<T_Refusal> list)
{
    IQueryable<T_Refusal> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Refusal t_refusal,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Refusal");
    return null;
}
	}
}
