...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Race t_race)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Race t_race, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_Race t_race)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_Race t_race, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_Race t_race)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_Race t_race)
{
}
private void CustomLoadViewDataListBeforeEdit(T_Race t_race)
{
}
private void CustomLoadViewDataListAfterEdit(T_Race t_race)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_Race t_race, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Race t_race, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Race t_race, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Race t_race, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Race> CustomSorting(IQueryable<T_Race> list)
{
    IQueryable<T_Race> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_Race t_race,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_Race");
    return null;
}
	}
}
