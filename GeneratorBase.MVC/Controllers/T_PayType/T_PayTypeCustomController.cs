...
{	
    ...
    {
		public bool CheckBeforeDelete(T_PayType t_paytype)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_PayType t_paytype, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_PayType t_paytype)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_PayType t_paytype, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_PayType t_paytype)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_PayType t_paytype)
{
}
private void CustomLoadViewDataListBeforeEdit(T_PayType t_paytype)
{
}
private void CustomLoadViewDataListAfterEdit(T_PayType t_paytype)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_PayType t_paytype, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_PayType t_paytype, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_PayType t_paytype, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_PayType t_paytype, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_PayType> CustomSorting(IQueryable<T_PayType> list)
{
    IQueryable<T_PayType> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_PayType t_paytype,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_PayType");
    return null;
}
	}
}
