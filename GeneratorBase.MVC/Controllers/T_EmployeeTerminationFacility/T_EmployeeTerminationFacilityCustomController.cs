...
private void CustomLoadViewDataListAfterOnCreate(T_EmployeeTerminationFacility t_employeeterminationfacility)
{
}
private void CustomLoadViewDataListBeforeEdit(T_EmployeeTerminationFacility t_employeeterminationfacility)
{
}
...
private bool CustomSaveOnCreate(T_EmployeeTerminationFacility t_employeeterminationfacility, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_EmployeeTerminationFacility t_employeeterminationfacility, out bool customsave_hasissues, string command="")
{
            var result = false;
...
private IQueryable<T_EmployeeTerminationFacility> CustomSorting(IQueryable<T_EmployeeTerminationFacility> list)
{
    IQueryable<T_EmployeeTerminationFacility> orderedList = list;
