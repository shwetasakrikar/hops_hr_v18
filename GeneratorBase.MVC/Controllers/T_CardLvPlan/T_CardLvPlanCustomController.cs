...
{	
    ...
    {
		public bool CheckBeforeDelete(T_CardLvPlan t_cardlvplan)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_CardLvPlan t_cardlvplan, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_CardLvPlan t_cardlvplan)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_CardLvPlan t_cardlvplan, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_CardLvPlan t_cardlvplan)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_CardLvPlan t_cardlvplan)
{
}
private void CustomLoadViewDataListBeforeEdit(T_CardLvPlan t_cardlvplan)
{
}
private void CustomLoadViewDataListAfterEdit(T_CardLvPlan t_cardlvplan)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_CardLvPlan t_cardlvplan, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_CardLvPlan t_cardlvplan, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_CardLvPlan t_cardlvplan, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_CardLvPlan t_cardlvplan, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_CardLvPlan> CustomSorting(IQueryable<T_CardLvPlan> list)
{
    IQueryable<T_CardLvPlan> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_CardLvPlan t_cardlvplan,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_CardLvPlan");
    return null;
}
	}
}
