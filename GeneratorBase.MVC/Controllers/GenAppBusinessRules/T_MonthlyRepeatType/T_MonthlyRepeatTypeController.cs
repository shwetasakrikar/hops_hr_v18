...
[AcceptVerbs(HttpVerbs.Get)]
	...
	break;
        ...
        public void OnSaving(T_MonthlyRepeatType t_monthlyrepeattype, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_MonthlyRepeatType t_monthlyrepeattype)
        {
            // Write your logic here
        ...
        public void GetTemplatesForList()
        {
            ...
            var lstDefaultEntityPage = from s in db.DefaultEntityPages
                                       where s.EntityName == "T_MonthlyRepeatType"
                                       select s;
