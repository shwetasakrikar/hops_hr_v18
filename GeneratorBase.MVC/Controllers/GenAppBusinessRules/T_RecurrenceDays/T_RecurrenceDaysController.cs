...
[AcceptVerbs(HttpVerbs.Get)]
	...
	break;
        ...
        public void OnSaving(T_RecurrenceDays t_recurrencedays, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_RecurrenceDays t_recurrencedays)
        {
            // Write your logic here
        ...
        public void GetTemplatesForList()
        {
            ...
            var lstDefaultEntityPage = from s in db.DefaultEntityPages
                                       where s.EntityName == "T_RecurrenceDays"
                                       select s;
