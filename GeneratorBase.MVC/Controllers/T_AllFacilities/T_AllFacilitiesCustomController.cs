...
{	
    ...
    {
		public bool CheckBeforeDelete(T_AllFacilities t_allfacilities)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_AllFacilities t_allfacilities, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_AllFacilities t_allfacilities)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_AllFacilities t_allfacilities, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_AllFacilities t_allfacilities)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_AllFacilities t_allfacilities)
{
}
private void CustomLoadViewDataListBeforeEdit(T_AllFacilities t_allfacilities)
{
}
private void CustomLoadViewDataListAfterEdit(T_AllFacilities t_allfacilities)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_AllFacilities t_allfacilities, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_AllFacilities t_allfacilities, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_AllFacilities t_allfacilities, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_AllFacilities t_allfacilities, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_AllFacilities> CustomSorting(IQueryable<T_AllFacilities> list)
{
    IQueryable<T_AllFacilities> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_AllFacilities t_allfacilities,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_AllFacilities");
    return null;
}
	}
}
