...
{	
    ...
    {
		public bool CheckBeforeDelete(T_InjuryCause t_injurycause)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_InjuryCause t_injurycause, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_InjuryCause t_injurycause)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_InjuryCause t_injurycause, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_InjuryCause t_injurycause)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_InjuryCause t_injurycause)
{
}
private void CustomLoadViewDataListBeforeEdit(T_InjuryCause t_injurycause)
{
}
private void CustomLoadViewDataListAfterEdit(T_InjuryCause t_injurycause)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_InjuryCause t_injurycause, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_InjuryCause t_injurycause, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_InjuryCause t_injurycause, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_InjuryCause t_injurycause, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_InjuryCause> CustomSorting(IQueryable<T_InjuryCause> list)
{
    IQueryable<T_InjuryCause> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_InjuryCause t_injurycause,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_InjuryCause");
    return null;
}
	}
}
