...
{	
    ...
    {
		public bool CheckBeforeDelete(T_OrgCodes t_orgcodes)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_OrgCodes t_orgcodes, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
		...
		public void OnDeleting(T_OrgCodes t_orgcodes)
        {
            // Write your logic here
 
		}
        public void OnSaving(T_OrgCodes t_orgcodes, ApplicationContext db)
        {
            // Write your logic here
 
        }
		public void AfterSave(T_OrgCodes t_orgcodes)
        {
            // Write your logic here
...
private void CustomLoadViewDataListAfterOnCreate(T_OrgCodes t_orgcodes)
{
}
private void CustomLoadViewDataListBeforeEdit(T_OrgCodes t_orgcodes)
{
}
private void CustomLoadViewDataListAfterEdit(T_OrgCodes t_orgcodes)
{
}
private void CustomLoadViewDataListOnIndex(string HostingEntity, int? HostingEntityID, string AssociatedType)
{
}
private bool CustomSaveOnCreate(T_OrgCodes t_orgcodes, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_OrgCodes t_orgcodes, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_OrgCodes t_orgcodes, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_OrgCodes t_orgcodes, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_OrgCodes> CustomSorting(IQueryable<T_OrgCodes> list)
{
    IQueryable<T_OrgCodes> orderedList = list;
	// Do custom sorting here
    return orderedList;
}
private RedirectToRouteResult CustomRedirectUrl(T_OrgCodes t_orgcodes,string action,string command="")
{
	// Sample Custom implemention below
    // return RedirectToAction("Index", "T_OrgCodes");
    return null;
}
	}
}
