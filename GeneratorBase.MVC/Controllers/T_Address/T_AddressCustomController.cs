...
{	
    ...
    {
		public bool CheckBeforeDelete(T_Address t_address)
        {
            var result = true;
		...
		public string CheckBeforeSave(T_Address t_address, string command ="")
        {
			var AlertMsg = "";
            // Write your logic here
...
private bool CustomSaveOnCreate(T_Address t_address, out bool customcreate_hasissues, string command="")
{
            var result = false;
			customcreate_hasissues = false;
            return result;
}
private bool CustomSaveOnEdit(T_Address t_address, out bool customsave_hasissues, string command="")
{
            var result = false;
			customsave_hasissues = false;
            return result;
}
private bool CustomSaveOnImport(T_Address t_address, out string customerror, int i)
{
            var result = false;
			customerror = "";
            return result;
...
private bool CustomDelete(T_Address t_address, out bool customdelete_hasissues, string command="")
{
            var result = false;
			customdelete_hasissues = false;
            return result;
}
private IQueryable<T_Address> CustomSorting(IQueryable<T_Address> list)
{
    IQueryable<T_Address> orderedList = list;
