    ...
    $.widget("bootstrap.bwizard", {
        ...
        _createButtons: function () {
            var self = this, o = this.options, bt,
                ...
                nextBtnText = o.nextBtnText,
                    saveBtnText = o.saveBtnText,
                CancelBtnText = o.CancelBtnText;
            this._removeButtons();
            ...
            if (!this.buttons) {
                ...
                if (backBtnText != '') {
                    this.backBtn =
                        $("<li class='previous '><a href='#' style='background:#daeaf4; color:#3784b1; border:0px'>" +
                            backBtnText + "</a></li>")
                ...
                if (nextBtnText != '') {
                    this.nextBtn =
                        $("<li class='next'><a href='#' style='background:#3784b1; color:white; border:0px'>" +
                            nextBtnText + "</a>")
                        .appendTo(this.buttons).bind({
                            'click': function () {
                                self.next();
                ...
                if (CancelBtnText != '') {
                    $("<li><a  href='javascript:deactive_tiptip();' class='btn btn-primary btn-sm' style='color:#3784b1;'>" +
                            CancelBtnText + "</a>").appendTo(this.buttons).attr("role", "button");
                    //cancel
                }
                if (requiresPager) {
        ...
        _pageLize: function (init) {
            ...
            if (init) {
                ...
                this.container = $('<div/>');
                this.container.addClass('bwizard-stepdiv');
        ...
        show: function (index) {
            ...
            if ($show.length) {
                ...
                this.load(index);
				 //focus on first input control on switching setps
                focusOnControlWizardStep(this.panels[index]);
            }
            else {
