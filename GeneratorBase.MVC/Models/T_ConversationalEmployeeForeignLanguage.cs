...
{
    [Table("tbl_ConversationalEmployeeForeignLanguage"),CustomDisplayName("T_ConversationalEmployeeForeignLanguage", "T_ConversationalEmployeeForeignLanguage.resx", "Conversational Employee Foreign Language")]
	public partial class T_ConversationalEmployeeForeignLanguage : Entity
    {	



		[CustomDisplayName("T_EmployeeID","T_ConversationalEmployeeForeignLanguage.resx","Employees Conversational In"), Column("EmployeeID")]
		...
		[CustomDisplayName("T_LangaugeID","T_ConversationalEmployeeForeignLanguage.resx","Conversational Foreign Language"), Column("LangaugeID")]
